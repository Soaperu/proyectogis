        ...
        If seleccion_opcion = "consulta_arearestringida" Then
            ...
            For A As Integer = 0 To pMap.LayerCount - 1
                If pMap.Layer(A).Name = "Zona Urbana" Then
                    pLayer = pMap.Layer(A)
                    nm_capa = pLayer.Name
                ElseIf pMap.Layer(A).Name = "Zona Reservada1" Then
                    pLayer = pMap.Layer(A)
                    nm_capa = pLayer.Name
                    afound = True
                    Exit For
            ...
            ' clsGoogleEarth.Genera_KML_Google_rese(m_application, v_zona_dm, "Zona Reservada1")  'Se hizo otra forma de llamarlo
            clsGoogleEarth.Genera_KML_Google_rese(m_application, v_zona_dm, nm_capa)  'Se hizo otra forma de llamarlo
        Else
            clsGoogleEarth.Genera_KML_Google_rese(m_application, v_zona_dm, "Catastro")
        End If

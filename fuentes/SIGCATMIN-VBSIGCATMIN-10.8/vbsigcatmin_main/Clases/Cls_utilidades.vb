...
Public Class cls_Utilidades
    ...
    Public Function CalculaInterseccion(ByVal pTipo As String, ByVal pLayerIn As String, ByVal p_App As IApplication, ByVal p_Zona As String, _
       ByVal p_LayerInt As String, ByVal pastrCodInterceptado As String)
        ...
        Do While Not pFeat Is Nothing
            ...
            Dim lodbtTotal = cls_oracle.FT_Int_Total(pTipo, loStrCoordenada, v_sistema, p_Zona, p_LayerInt, pastrCodInterceptado)
            ...
            Else
                lodbtParcial = cls_oracle.FT_Int_Parcial(pTipo, loStrCoordenada, v_sistema, p_Zona, p_LayerInt)
    ...
    Public Function CalculaInterseccion_neto(ByVal pTipo)
        ...
        '    MsgBox("No hay ninguna Selecci�n")
        '    Exit Function
        'End If
    ...
    Public Function CalculaInterseccion_0(ByVal pTipo As String, ByVal pLayerIn As String, ByVal p_App As IApplication, ByVal p_Zona As String, _
        ...
        Dim loCampo As String = ""
        'If pLayerIn = "ZonaUrbana_10Ha" Then
        If pLayerIn.StartsWith("ZonaUrbana_10Ha") Then
        ...
        Do While Not pFeat Is Nothing
            ...
            Dim lodbtTotal = cls_oracle.FT_Int_Total(pTipo, loStrCoordenada, v_sistema, p_Zona, p_LayerInt, pastrCodInterceptado)  'se descomenta 231221
            'Dim lodbtTotal = cls_oracle.P_Int_Total(pTipo, loStrCoordenada, p_Zona, p_LayerInt, pastrCodInterceptado, lostrCodigo_clase_reserva)  se comenta 231221
            ...
            Else
                ...
                lodbtParcial = cls_oracle.FT_Int_Parcial(pTipo, loStrCoordenada, v_sistema, p_Zona, p_LayerInt)    'se descomenta 231221
                'lodbtParcial = cls_oracle.P_Int_Parcial(pTipo, loStrCoordenada, p_Zona, p_LayerInt, pastrCodInterceptado, lostrCodigo_clase_reserva)   se comenta 231221
        ...
        For i As Integer = 0 To lo_Tabla.Rows.Count - 1
            ...
            Else
                ...
                Select Case pStyleItem.Name
                    Case "G1"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. en Tr�mite" 'Color Tramite
                    Case "G2"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. en Tr�mite D.L. 109" 'Color Tramite 109
                    Case "G3"
    ...
    Public Sub Cargar_FeatureClass_SDE()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            MsgBox("Error de Asignaci�n de Feature Class.... ", MsgBoxStyle.Information, "[BDGEOCATMIN]")
        End Try
    End Sub
    ...
    '        pStatusBar.Message(0) = "Operaci�n Completado"
    ...
    '        Return "No"
    '        'MsgBox("Las coordenadas Este, Norte, � la Zona est�n fuera del L�mite")
    '    End If
    '    Return "Si"
    'End Function
    ...
    Public Sub Genera_Linea(ByVal lodtbTabla As DataTable, ByVal lo_Zona As String, ByVal m_Application As IApplication)
        ...
        Catch ex As Exception
            MsgBox("Generaci�n de L�nea fall�", MsgBoxStyle.Information, "GisCatMin")
        End Try
    End Sub

...
Public Class cls_DM_2
    ...
    Public Sub Genera_Catastro_DM(ByVal p_Consulta As String, ByVal lo_Zona As String, ByVal pApp As IApplication)
        Try
            ...
            ElseIf v_opcion_modulo = "OP_30" Then
                'If v_sistema = "PSAD-56" Then
                tipo_ac = "4"
                lodtbDatos = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, v_nombre_dm, tipo_ac)  '12092022
                'ElseIf v_sistema = "WGS-84" Then
                '    tipo_ac = "4"
                '    'lodtbDatos = cls_Oracle.F_Obtiene_Datos_DM_84_AC(p_Consulta)
                '    lodtbDatos = cls_Oracle.FT_DATA_ACUMULACION(p_Consulta, tipo_ac)
            ...
            If v_opcion_modulo <> "OP_29" And v_opcion_modulo <> "OP_30" And v_opcion_modulo <> "OP_32" Then
                'If v_sistema = "PSAD-56" Then
        ...
        End Try
    End Sub
    Public Sub Genera_Catastro_DM_reg(ByVal p_Consulta As String, ByVal lo_Zona As String, ByVal pApp As IApplication)
        Try
            Dim cls_Oracle As New cls_Oracle
            Dim lodtbDatos_hecta As DataTable
            Dim pSpatialReferenceEnv As SpatialReferenceEnvironment = New SpatialReferenceEnvironment
            ...
            Dim bFound As Boolean = False
            For A As Integer = 0 To pMap.LayerCount - 1
                If pMap.Layer(A).Name = "gpt_Vertice_DM_" & v_zona_dm Then
                    lo_pFLayerDMP = A
                    bFound = True
                    Exit For
                End If
    ...
    Public Sub Genera_Poligono_100Ha(ByVal lodtbDatos As DataTable, ByVal p_Zona As String, ByVal pApp As IApplication, Optional ByVal p_Flag As String = "")
        ...
        Try
                        ...
                        Case "Si"
                            If sele_cuadri = "100" Then
                                Select Case z
                                    ...
                                    Case 11
                                        pFeatureDM.Value(pFeatureDM.Fields.FindField("CODIGOU")) = "K" ' lodtbDatos.Rows(i).Item(DataXY.iCodigoID) ' pRow.Value(DataInfo(L + 1).Index)
                                    Case 12
                                        pFeatureDM.Value(pFeatureDM.Fields.FindField("CODIGOU")) = "L" ' lodtbDatos.Rows(i).Item(DataXY.iCodigoID) ' pRow.Value(DataInfo(L + 1).Index)
            ...
            pEditor.StopEditing(True)
            pStatusBar.HideProgressBar()
            pStatusBar.Message(0) = "Operación Completada"

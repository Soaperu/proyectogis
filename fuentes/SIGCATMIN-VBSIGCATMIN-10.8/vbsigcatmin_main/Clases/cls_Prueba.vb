...
Public Class cls_Prueba
        ...
        For i As Integer = 0 To lo_Tabla.Rows.Count - 1
            ...
            Else
                ...
                Select Case pStyleItem.Name
                    ...
                    Case "G7"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "DM_ Anap"         '@ce  ---   activo
                    Case "G8"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. con Res. Ext. sin Consentir"     '@ce  ---  activo

                    Case "ZONA RESERVADA"     '"C1"     @caram
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "Zona Reservada"
                    Case "ZONA URBANA"     '"C2" 
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "Zona Urbana"
                    Case "CARAM"     '"C2" 
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "Caram"
                End Select
            End If
            'End If
            'pRow = pCursor.NextRow
    ...
    Public Sub Poligono_Color_UEA(ByVal lo_FeatureClass As String, ByVal lo_Tabla As DataTable, ByVal loStyle As String, ByVal loCampo As String, ByVal p_Categoria As String, ByVal p_App As IApplication)
        Dim pUniqueValueRenderer As IUniqueValueRenderer
        ' Define the renderer.
        pUniqueValueRenderer = New UniqueValueRenderer
        pUniqueValueRenderer.FieldCount = 1
        ...
        For i As Integer = 0 To lo_Tabla.Rows.Count - 1
            ...
            Do While Not pStyleItem Is Nothing   'Loop through and access each marker
                ...
                If pStyleItem.Name = lo_Tabla.Rows(i).Item(loCampo) Then
                    ...
                    'If pStyleItem.Name = "C" Then
                    '    pStyleItem.Name = "G3"
                    'ElseIf pStyleItem.Name = "I" Then
                    '    pStyleItem.Name = "G1"
                    'ElseIf pStyleItem.Name = "X" Then
                    '    pStyleItem.Name = "G2"
                    'End If
            ...
            Else
                ...
                Select Case pStyleItem.Name
                    Case "C"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. Constituidos"
                    Case "I"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. Incluidos"
                    Case "S"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. Excluidos en Trámite"
                    Case "X"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. Excluidos"
                    Case "Z"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "D.M. Incluidos en Trámite"
                End Select
            End If
            'End If
            'pRow = pCursor.NextRow
    ...
    Public Sub Poligono_Color_PMA(ByVal lo_FeatureClass As String, ByVal lo_Tabla As DataTable, ByVal loStyle As String, ByVal loCampo As String, ByVal p_Categoria As String, ByVal p_App As IApplication)
        Dim pUniqueValueRenderer As IUniqueValueRenderer
        ' Define the renderer.
        pUniqueValueRenderer = New UniqueValueRenderer
        pUniqueValueRenderer.FieldCount = 1
        ...
        For i As Integer = 0 To lo_Tabla.Rows.Count - 1
            ...
            Else
                ...
                Select Case pStyleItem.Name
                    Case "L001"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L001"
                    Case "L002"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L002"
                    Case "L003"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L003"
                    Case "L004"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L004"
                    Case "L005"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L005"
                    Case "L006"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L006"
                    Case "L007"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L007"
                    Case "L008"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L008"
                    Case "L009"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L009"
                    Case "L010"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L010"
                    Case "L011"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L011"
                    Case "L012"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L012"
                    Case "L013"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L013"
                    Case "L014"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L014"
                    Case "L015"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L015"
                    Case "L016"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L016"
                    Case "L017"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L017"
                    Case "L018"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L018"
                    Case "L019"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L019"
                    Case "L020"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L020"
                    Case "L021"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L021"
                    Case "L022"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L022"
                    Case "L023"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L023"
                    Case "L024"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L024"
                    Case "L025"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L025"
                    Case "L026"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L026"
                    Case "L027"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L027"
                    Case "L028"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L028"
                    Case "L029"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L029"
                    Case "L030"
                        pUniqueValueRenderer.Label(lo_Tabla.Rows(i).Item(loCampo)) = "L030"
                End Select
            End If
        Next
        Dim pLayer As IFeatureLayer = Nothing

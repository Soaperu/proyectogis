...
Public Class frm_Grafica_Consulta_DM
    ...
    Private Sub Get_Item_DM()
        ...
        Try
            ...
            If (pFeature.Value(pFeature.Fields.FindField("BLOQUEO")) = "1") Then
                Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO")) & " - Anap"
            Else
                Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO"))
            End If

            'If (pFeature.Value(pFeature.Fields.FindField("BLOQUEO")) = "1") And (pFeature.Value(pFeature.Fields.FindField("RESEXT")) = "Morado") Then       '@ce
            '    Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO")) & " - Anap - Sin consentir"
            'ElseIf (pFeature.Value(pFeature.Fields.FindField("BLOQUEO")) = "1") Then
            '    Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO")) & " - Anap"
            'ElseIf (pFeature.Value(pFeature.Fields.FindField("RESEXT")) = "Morado") Then
            '    Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO")) & " - Sin Consentir"
            'Else
            '    Me.txtTipo.Text = pFeature.Value(pFeature.Fields.FindField("D_ESTADO"))
            'End If

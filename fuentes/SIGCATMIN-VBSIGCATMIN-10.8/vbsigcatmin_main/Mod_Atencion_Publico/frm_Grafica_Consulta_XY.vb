...
Public Class frm_Grafica_Consulta_XY
    ...
    Private Sub frm_Grafica_Consulta_XY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' agregamos esta linea para poder utilizar enums
        Dim int_opcion_modulo As Integer = Convert.ToInt32(v_opcion_modulo.Substring(3))

        Select Case int_opcion_modulo
            Case OpcionModulo.Acumulacion
                If pMap.Name <> "ACUMULACION ARESTRINGIDA" Then
                    ...
                    '    Exit Sub
                End If
            Case OpcionModulo.Renuncia
                If pMap.Name <> "RENUNCIA ARESTRINGIDA" Then      'If pMap.Name <> "RENUNCIA DM" Then
                    MsgBox("No es el caso para Calcular Porcentaje de Región", MsgBoxStyle.Information, "BDGEOCATMIN")
                    Exit Sub
                End If
            Case Else
        ...
        '    ElseIf pMap.Name <> "CATASTRO MINERO" Then
        '        MsgBox("No es el caso para Calcular Porcentaje de Región", MsgBoxStyle.Information, "BDGEOCATMIN")
        '        Exit Sub
        ...
        If pSelectionSet.Count > 0 Then
            ...
            Do Until pFeature Is Nothing
                ...
                ElseIf pFeatureLayer.Name = "Cuadri_new" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("ORIG_FID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("COD_REMATE"))
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("AREA")), 4), "###,###.#000")
                ...
                ElseIf pFeatureLayer.Name = "urba_acum" Then
                    ...
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuncia" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("CONCESION")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAGIS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuret1" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuren1" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuret2" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuren2" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuret3" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuren3" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuret4" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "Renuren4" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGOU"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("TIPO_RENUN")) '& "  " & area_renuncia
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "rese_renun" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGO"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("NM_RESE"))
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HAS")), 4), "###,###.#000")
                ElseIf pFeatureLayer.Name = "urba_renun" Then
                    dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                    dRow.Item("CODIGO") = pFeature.Value(pFeature.Fields.FindField("CODIGO"))
                    dRow.Item("NOMBRE") = pFeature.Value(pFeature.Fields.FindField("NM_URBA"))
                    ' dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAREA")), 4), "###,###.#000")
    ...
    Private Sub btnReporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReporte.Click
        ...
        p.StartInfo = New ProcessStartInfo("notepad.exe", "C:\BDGEOCATMIN\listado.txt")
        Dim listado As String = glo_Path & "listado.txt"
        Try
            p.StartInfo = New ProcessStartInfo("notepad.exe", listado)
            p.Start()
        Catch ex As Exception
            Try
                'Shell("C:\Windows\system32\notepad.exe " & listado, AppWinStyle.NormalFocus)
                'Shell("C:\Windows\system32\notepad.exe", listado, AppWinStyle.NormalFocus)
                Shell("C:\Windows\system32\notepad.exe", "C:\BDGEOCATMIN\listado.txt", AppWinStyle.NormalFocus)
    ...
    Private Sub lblFound_Click(sender As Object, e As EventArgs) Handles lblFound.Click

...
Public Module Modulo_Principal

    Public val_opcion_plano_Ar As String

    '070621

    Public rutaplantillas_Ar As String = "C:\BDGEOCATMIN\TEMPORAL\"
    Public v_tp_ar_sele As String = ""
    Public union_nombre_ar As String = ""
    Public v_clase_rese As String
    Public val_nltipnorma As String = ""
    Public val_TIPO_norma As String = ""
    Public val_TIP_RESO_norma As String = ""
    Public val_cadena_norma As String = ""
    ''CONEXION PYTHON 

    ''Public _main_batch As String = "U:\DATOS\SHAPE\process\execute"     '>>>>   PRODUCCION
    'Public _main_batch As String = "U:\DATOS\SHAPE\test\execute"       '>>>>>  DESARROLLO
    'Public _bat_ueas As String = _main_batch & "\unidad_economica_administrativa.bat"
    'Public _bat_renuncia As String = _main_batch & "\generar_geometrias.bat"
    'Public _bat_simultaneidad As String = _main_batch & "\simultaneidad.bat"
    'Public _parametros As String
    'Public _fn_graficar As String
    'Public v_repocirculo As Integer = 0
    ' ''''''''''
    Public valida_urb_shp As String = "0"
    Public glo_pathStyle_URB As String = "U:\GEOCATMIN\Estilos\"
    Public glo_pathStyle_URB_56 As String = "U:\GEOCATMIN\Estilos\psad56\"
    Public MensajeHablado As SpeechSynthesizer = New SpeechSynthesizer()

    '*********************

    Public ruta As String = ""
    Public ruta1 As String = ""
    Public cuenta_proceso As Long = 0

    '*******

    Public title_messagebox As String = Now.Year.ToString() & " Sigcatmin"
    ...
    Public gstrDatabase As String = "ORACLE"                       'PRODUCCION
    'Public gstrDatabase As String = "GAMMA02"  'usado abril 2021    'DESARROLLO

    '''Public gstrDatabase As String = "GAMMAD"    'DESARROLLO
    ...
    Public gstrFC_CARAM As String = ""      '@CQ
    Public gstrFC_CARAM56 As String = ""   'CQ
    ...
    Public gstrFC_prediorural As String = "DATA_CAT.MIDAGRI_1501_PREDRUST"
    ...
    Public glo_pathPYTHON As String = "C:\BDGEOCATMIN\"
    Public glo_pathTEMP As String = "C:\BDGEOCATMIN\Temporal\"
    Public glo_pathT As String = "C:\BDGEOCATMIN\template\"
    ...
    Public v_morado As String = "0"
    Public v_activar As String = "0"
    Public vzona As String = "0"

    Public kuenta As Integer = 0
    ...
    Public dt_dmubigeo As New DataTable
    ...
    Public param_prioritario As String          '@ce
    Public capabase As String
    Public capasalida As String
    ...
    Public dtsimul As New DataTable
    Public v_dmxgrupo As New DataTable
    Public v_concesionxgrupo As New DataTable
    'Public v_updmxgrupo As String = ""

    'Public TableDMSimul As String = "DMSimul"
    Public TableDMSimul As String
    'Dim rutaTableDMSimul As String = "C:\BDGEOCATMIN\Temporal\Simultaneos"

    Public v_areasim As Integer
    Public v_areasim1 As Integer
    Public v_areasim2 As Integer
    Public op_sim As Integer
    Public cuenta_sim As Integer = 0
    Public cuad As String
    Public grusim As String
    Public subg As String
    Public subg1 As String = ""
    Public subg2 As String = ""
    Public v_cuamap As String = ""
    Public num_ver As Integer = 0
    Public fecha_archi_sim As String = ""
    Public fecha_archi_simul As String = ""
    Public v_identi As String = ""
    Public v_cd_hoja As String = ""
    Public v_nm_hoja As String = ""

    Public v_cod_remate As String = ""
    Public v_dm_prioritario As String = ""
    Public dm_prioritario_sim As String = ""

    Public listaDmSim As New List(Of String)

    ' CARAM
    Public v_existe_ca As String = ""
    Public lodbtExisteCA As New DataTable


    'PMA 
    Public v_petpma As New DataTable
    Public v_petdmpma As New DataTable
    Public dt_PMA As New DataTable
    Public lista_codigo_titular As String
    Public petdmpma As String
    Public petpma As String

    'Libre Denunciabilidad 
    Public dt_DMlibreden As New DataTable
    Public dt_ARElibreden As New DataTable
    Public lista_codigo_are As String = ""
    Public listadmARE As New List(Of String)
    Public listadm84 As New List(Of String)
    Public listadm56 As New List(Of String)

    'PORCENTAJE DE UBICACION

    Public v_annoporcubi As String
    Public dt_annoPU As New DataTable
    Public token As String = "70dad6bd-057f-4512-b7f3-82fb588a1721"

    '@UEA
    Public statusxinclusion As String = "0"
    Public statusxcambio As String = "0"
    Public dt_DataUEA As New DataTable
    Public in_DataUEA As New DataTable
    Public ex_DataUEA As New DataTable
    Public dt_DemaUEA As New DataTable

    Public radio As Double
    Public este As Double
    Public norte As Double

    Public tabla_demarcacion As New DataTable
    Public tabla_integrantes As New DataTable

    Public lista_integraUEA As String
    Public lista_integraexUEA As String
    Public lista_integrainUEA As String
    Public lista_integradoUEA As String
    Public lista_exclusionUEA As String
    Public lista_inclusionUEA As String
    Public v_areainclusionUEA As Single
    Public v_areaexclusionUEA As Single
    Public v_areaUEA As Double
    Public v_area_circuloUEA As Single
    Public v_areamax_extUEA As Single
    Public v_areaextUEA As Single
    Public zona As String
    Public name_circulo As String
    Public name_tcirculo As String
    Public v_zonasim As String
    Public _integrado As Integer = 0
    Public tipo_integranteUEA As String
    'Public path_style As String = "U:\Geocatmin\Estilos\"

    '@Daniel
    Public loader_proceso_general As String = "proceso_general_sigcatmin.exe"
    Public loader_proceso_buscar As String = "proceso_buscar_sigcatmin.exe"
    Public path_loader_proceso_general As String = glo_Path & "\loaders\" & loader_proceso_general
    Public path_loader_proceso_buscar As String = glo_Path & "\loaders\" & loader_proceso_buscar
    Public _activar_btn_reporte_circulo_uea As Integer = 0
    Public coduea As String

    'demarcacion
    Public ListaDep As New List(Of String)
    Public ListaProv As New List(Of String)
    Public ListaDist As New List(Of String)
    ...
    Public lista_caram As String = ""
    Public lista_caramur As String = ""
    Public lista_caramre As String = ""
    ...
    Public v_checkbox_1 As String = ""
    Public v_checkbox_2 As String = ""
    Public v_checkbox_3 As String = ""
    Public v_checkbox_4 As String = ""
    ...
    Public pFeatureLayer_caram As IFeatureLayer
    ...
    'PARA ACUMULACION - DIVISION - RENUNCIA 
    Public kuentadiv As Integer = 0
    Public kuentarenun As Integer = 0
    Public v_opcion_modulo As String = ""
    Public v_integracumulacion As New DataTable
    Public v_existe_zr, v_existe_zu As Integer
    Public v_hectadiv As Double = 0
    Public v_concediv As String = ""
    Public v_codidiv As String = ""
    Public lodtbDatosdiv As New DataTable
    Public lodtbDatosren As New DataTable
    Public lista_forestaldiv As String = ""
    Public area_renuncia As String = ""
    Public v_renuncia As String = ""
    Public py_codigo As String = ""
    Public idzona As Integer = 0
    Public v_nombre_div As String = ""
    Public v_tipo_renun As String = ""

    Public lodbListaValDM As New DataTable
    Public pQueryFilter_div As IQueryFilter
    ...
    'REPORTE DM SUPERPUESTO X DIA

    Public fecrepo As String = ""
    Public fecrepo_inicio As String = ""
    Public fecrepo_fin As String = ""
    ...
    Public lointArea1 As String = ""    ' para FA

    Public colecciones_txtfiles As New Collection

    ' Public ruta_rese = "C:\Caram\Catastro2015\uca\Procesos\datos\shape\"
    '  Public ruta_rese = "c:\Caram\Catastro2018\UAR\Procesos\datos\shape\"
    ' Public ruta_procesado = "c:\Caram\Catastro2018\UAR\Procesado\datos\shape\"
    'Public ruta_IMAGENES = "\\srvfile01\carpetas_oficinas_artes$\DC\ImagenesDerechoMinero\"


    Public ruta_rese = ""
    Public ruta_procesado = ""
    ...
    '@Daniel
    Public array_nmrese_sup As New List(Of String)
    ...
    Public caso_plano As String
    Public v_usuario_Ar As String

    Public ruta_plano_ar = "\\ingemmet.int\FileServer\carpetas_Oficinas_Lenguaje\DC\PlanoAreasRestringidas\"
    'Public ruta_plano_ar = "C:\bdgeocatmin\Temporal\regional\"
    Public v_estado_Ar As String = "0"

    Public v_porent_region = 0

    Public canti_priorif As Integer = 0

    Public tipo_casomin As String = ""

    Public caso_nuevo As Long

    'caram
    Public pFeatureLayer_areanat As IFeatureLayer

    'Areas netas

    Public glo_proceso As String = glo_Path & "Proceso"
    ...
    Public Function get_url_addin()
        Dim bytes() As Byte
        Dim reader As New IO.StreamReader(glo_pathPYTHON & "pysigcatmin.config")
    ...
    Public Function get_option_cbox(ByVal cbox As Object, ByVal dgrid As DataTable)
        Dim dgridView As New DataView(dgrid)
        cbox.DataSource = dgridView
        cbox.ValueMember = "CB_VALOPT"
        cbox.DisplayMember = "CB_DESOPT"
    End Function

    Public Function error_scripttool_as_messagebox(ByVal errormessage As String)
        Dim err = Split(errormessage, ",")
        Dim txt As String
        For Each i As String In err
            txt = txt & i & vbCrLf
        Next
        MessageBox.Show(txt, title_messagebox, MessageBoxButtons.OK, MessageBoxIcon.Error)
    End Function
    ...
    Public sele_opcion_plano As String = ""

    Public cadena_planos_espe As String = ""
    'NUEVO 270818
    Public V_tipoaplica As String = ""

    'nuevo 040918
    Public seleccion_opcion = ""
    Public VO_OPCION As String = ""

    'CONEXION PYTHON      

    'Public _main_batch As String = "U:\DATOS\SHAPE\process\execute"     '>>>>   PRODUCCION
    'Public _main_batch As String = "U:\DATOS\SHAPE\test\execute"       '>>>>>  DESARROLLO
    Public _main_batch As String = get_url_addin()
    Public _bat_ueas As String = _main_batch & "\unidad_economica_administrativa.bat"
    Public _bat_renuncia As String = _main_batch & "\generar_geometrias.bat"
    Public _bat_simultaneidad As String = _main_batch & "\simultaneidad.bat"
    Public _bat_porcentaje_ubicacion As String = _main_batch & "\porcentaje_ubicacion.bat"
    Public _bat_libden As String = _main_batch & "\libre_denunciabilidad.bat"
    Public _parametros As String
    Public _fn_graficar As String
    Public v_repocirculo As Integer = 0
    ''''''''''
    Public control_cancel As Integer = 0

    'inicia @CQ

    Public v_bloqueo_dm As String = ""
    Public p_grafica1 As String = ""
    Public v_masivo_eval As String = ""

    'Finaliza @CQ

  Public  fecha_archi_seleccion as string
    Public pLayer_seleccion As IFeatureLayer
    Public loStrShapefile_4 As String = ""
    Public pfeaturelayercuadriculas As IFeatureLayer
    '@CQ   PARA SIMULACION 1900919
    Public v_datum_eval As String


    'nuevo

    Public v_opcion_mas As String = ""
    Public cuenta_cuad_parciales As Long
    Public contador_cua As Long
    Public cuenta_cuad_suptot As Long

    Public pFeatureLayer_tmp_recta As IFeatureLayer
    Public loStrShapefile_cat_cuad As String
    Public loStrShapefile_5 As String = ""

    'COLOCAR LIBRE DENU

    Public caso_ldmasivo = "0"
    Public gloNamezona As String
    Public gloNamenombre As String
    Public contador_regcat As Integer

    Public _url_InteractionAPI As String = "https://geocatminapp.ingemmet.gob.pe/bdgeocientifica/app/api/account/IteracionService/17/{0}"

    Public Sub requestInteraction(name_module As String)
        If (gstrUsuarioAcceso = "cego0891" Or gstrUsuarioAcceso = "jyup2152") Then
            Return
            'Console.WriteLine("developer user")
        End If
        Try
    ...
    ''' <summary>
    ''' Se creo un objeto enum para identificar todas las opciones del modulo
    ''' </summary>
    ''' <remarks></remarks>
    Public Enum OpcionModulo
        CodigoCartaNacional = 1
        CodigoDM = 2
        CoordenadaPuntoCentral = 3
        AreasRestringidas = 4
        DMporCartaIGM = 5
        DMporDemarcacionPolitica = 6
        LimiteDepartamental = 7
        LimiteDistrital = 8
        LimiteAreasInteres = 9
        LimiteProvincial = 10
        EvaluacionDM = 11
        SimulacionPetitorios = 12
        VariasCartasNacionales = 13
        CartaGeologica = 14
        ActAreasGeodatabase = 15
        LibreDenunciabilidad = 16
        CalculoAreaNeta = 17
        PlanoGeologicoMasivo = 19
        GeneracionHistoricaDM = 20
        EstadisticasAreasRestringidas = 21
        ActualizacionCuadriculasRegionales = 22
        SuperpuestoPorDia = 23
        SimultaneidadPetitorios = 24
        DMporPMA = 25
        IngresoMantenimientoAR = 26
        PlanoAreasRestringidas = 27
        DataHistoricaporCarta = 28
        Acumulacion = 29
        Division = 30
        ActualizacionAcceditarios = 31
        Renuncia = 32
        GenerarPorcentajeUbicacion = 33
        UnidadEconomicaAdministrativa = 34
        CartaDM = 35

    End Enum

    Public ColeccionGraficos As Collection = New Collection()
End Module

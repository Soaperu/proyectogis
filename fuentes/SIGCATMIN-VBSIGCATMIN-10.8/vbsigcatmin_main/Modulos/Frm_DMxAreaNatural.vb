...
Public Class Frm_DMxAreaNatural
    ...
    Private Sub Frm_DMxAreaNatural_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            lodtTabla.Columns.Add("TP_AREA", Type.GetType("System.String"))
            lodtTabla.Columns.Add("NM_AREA", Type.GetType("System.String"))
            ...
            Do Until pFeature Is Nothing
                ...
                dRow.Item("TP_AREA") = pFeature.Value(pFeatureLayer.FeatureClass.Fields.FindField("TP_AREA"))
                dRow.Item("NM_AREA") = pFeature.Value(pFeatureLayer.FeatureClass.Fields.FindField("NM_AREA"))
    ...
    Private Sub PT_Forma_Grilla_EVAL()
        ...
        Me.dgdDetalle.Columns("NM_RESE").Caption = "NM_AREA"
        Me.dgdDetalle.Columns("TIP_RESE").Caption = "TP_AREA"
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            For w As Integer = 0 To dgdDetalle.BindingContext(dgdDetalle.DataSource, dgdDetalle.DataMember).Count - 1
                ...
                valor7 = valor7 & dgdDetalle.Item(w, "NM_AREA").ToString
                lodouHa = dgdDetalle.Item(w, "AREA").ToString
                '  valor5 = dgdDetalle.Item(w, "TIP_RESE").ToString
                valor5 = dgdDetalle.Item(w, "TP_AREA").ToString
                ...
                Select Case dgdDetalle.Item(w, "TP_AREA")
                    Case "AREA NATURAL"
            ...
            For j As Integer = 0 To dgdDetalle.BindingContext(dgdDetalle.DataSource, dgdDetalle.DataMember).Count - 1
                ...
                Do Until pFeature Is Nothing
                    ...
                    Else
                        ...
                        v_nmrese = pFeature.Value(pFeatureCursor.FindField("NM_AREA")).ToString
                    End If
                    ...
                    Else
                        ...
                        v_tprese = pFeature.Value(pFeatureCursor.FindField("TP_AREA")).ToString
                    End If
                    ...
                    pFeaturepout.Value(pFeatureCursorpout.FindField("NM_AREA")) = v_nmrese
                    ...
                    pFeaturepout.Value(pFeatureCursorpout.FindField("TP_AREA")) = v_tprese

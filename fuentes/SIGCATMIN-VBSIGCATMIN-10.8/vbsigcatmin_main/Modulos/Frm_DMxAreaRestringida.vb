...
Public Class Frm_DMxAreaRestringida
    ...
    Private Sub Frm_DMxAreaRestringida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Do Until pFeature Is Nothing
                ...
                lointArea1 = (Format(Math.Round(pArea.Area / 10000, 4), "###,###.0000")).ToString
                ptcol = l
                ...
                dRow.Item("TP_RESE") = pFeature.Value(pFeatureLayer.FeatureClass.Fields.FindField("TP_AREA"))
                ...
                dRow.Item("NM_AREA") = pFeature.Value(pFeatureLayer.FeatureClass.Fields.FindField("NOMBRE"))
    ...
    Private Sub PT_Forma_Grilla_EVAL()
        ...
        Me.dgdDetalle.Columns("NM_AREA").Caption = "NM_AREA"
        'Me.dgdDetalle.Columns("TIP_RESE").Caption = "TIP_RESE"
        Me.dgdDetalle.Columns("TP_AREA").Caption = "TP_AREA"
        ...
        For w As Integer = 0 To dgdDetalle.BindingContext(dgdDetalle.DataSource, dgdDetalle.DataMember).Count - 1
            ...
            If dgdDetalle.Item(w, "SELEC") = True Then
                ...
                Else
                   ...
                   lointArea1, vTipo, gstrUsuarioAcceso)    'lointArea1  <--  lodouHa

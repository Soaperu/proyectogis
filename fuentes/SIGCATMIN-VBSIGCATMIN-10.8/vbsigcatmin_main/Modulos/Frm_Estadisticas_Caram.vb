...
Public Class Frm_Estadisticas_Caram
    ...
    Private Sub PT_Forma_Grilla_EVAL()
        ...
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Codigo).Width = 50
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Nombre).Width = 50
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_tprese).Width = 150
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_nm_tprese).Width = 1
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Area).Width = 80
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Cantidad).Width = 80
        ...
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Nombre).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_tprese).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        ' Me.dgdDetalle.Splits(0).DisplayColumns(Col_nm_tprese).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        ...
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Cantidad).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Areasup).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Por_Sup).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify

        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Sel_R).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Codigo).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Nombre).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_tprese).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        '   Me.dgdDetalle.Splits(0).DisplayColumns(Col_nm_tprese).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Area).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Cantidad).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Areasup).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Por_Sup).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Justify
                ...
                Try
                    ...
                    Else
                        For contador1 As Integer = 0 To lodbtExiste_tipo.Rows.Count - 1
                            ...
                            Else
                                If v_nm_depa = "AREA NATURAL" Then
                                    cbotiporese.Items.Add("AMORTIGUAMIENTO")
                                End If
            ...
            ElseIf cbotipo.SelectedItem = "MINERIA A NIVEL NACIONAL" Then
                ...
                Try
                    ...
                    Else
                        For contador1 As Integer = 0 To lodbtExiste_tipo.Rows.Count - 1
                            v_nm_depa = lodbtExiste_tipo.Rows(contador1).Item("TN_DESTIP")
                            'No entra a la lista por tipo

                            If v_nm_depa = "EXPEDIENTE DE CATASTRO" Or v_nm_depa = "OTRA AREA RESTRINGIDA" Or v_nm_depa = "RESERVA TURISTICA" Or v_nm_depa = "CONCESION DE LABOR GENERAL" Or v_nm_depa = "ANAD" Or v_nm_depa = "INFRAESTRUCTURA DEL ESTADO" Or v_nm_depa = "PRODUCTOR MINERO ARTESANAL" Or v_nm_depa = "CONCESION DE TRANSPORTE MINERO" Or v_nm_depa = "CONCESION DE LABOR GENERAL" Then
                            Else
                                'Agrega al cnontrol mineria si/no según sea el caso

                                If v_nm_depa = "AREA NATURAL" Then
                                    '   cbotiporese.Items.Add("AMORTIGUAMIENTO")
                                    cbotiporese.Items.Add("AREA NATURAL - USO INDIRECTO")
                                    cbotiporesemin.Items.Add("AREA NATURAL - USO DIRECTO")
                                    cbotiporesemin.Items.Add("AREA NATURAL - AMORTIGUAMIENTO")
                                    cbotiporesemin.Items.Add("CLASIFICACION DIVERSA")
                                    cbotiporese.Items.Add("CLASIFICACION DIVERSA")
                                    cbotiporesemin.Items.Add("AREA DE CONSERVACION PRIVADA")
                                    cbotiporesemin.Items.Add("AREA DE CONSERVACION MUNICIPAL Y OTROS")


                                ElseIf v_nm_depa = "PROYECTO ESPECIAL" Then
                                    cbotiporese.Items.Add("PROYECTO ESPECIAL - HIDRAULICOS")
                                    cbotiporesemin.Items.Add("PROYECTO ESPECIAL (no hidráulicos)")
                                Else
                                    If v_nm_depa = "PROPUESTA DE AREA NATURAL" Then
                                        cbotiporesemin.Items.Add("PROPUESTA DE AREA NATURAL")
                                    ElseIf v_nm_depa = "POSIBLE ZONA URBANA" Then
                                        cbotiporesemin.Items.Add("POSIBLE ZONA URBANA")
                                        cbotiporesemin.Items.Add("AREA DE EXPANSION URBANA")
                                    Else
                                        cbotiporese.Items.Add(v_nm_depa)
                                    End If
                ...
                Me.cbotiporese.Enabled = True
                Me.cbotiporese.SelectedIndex = 0
                Me.cbotiporesemin.SelectedIndex = 0
    ...
    Private Sub btncalcular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncalcular.Click
        ...
        Dim lodbtExiste_SupAR As New DataTable
        Dim dRow As DataRow
        Dim v_areasup_rese_inge As Double
        Dim v_cantidad_inge As Integer
        ...
        'Dim ruta1 As String = glo_Path & "reportearq.txt"


        ruta = glo_Path & "reporte.txt"
        ruta1 = glo_Path & "reportearq.txt"

        Dim sw As New System.IO.StreamWriter(ruta)
        Dim sw1 As New System.IO.StreamWriter(ruta1)
        lodtTabla.Columns.Add("SELEC", Type.GetType("System.String"))
        lodtTabla.Columns.Add("CODIGO", Type.GetType("System.String"))
        lodtTabla.Columns.Add("NOMBRE", Type.GetType("System.String"))
        ...
        ElseIf tipo_selec_catnomin = "SEGUN DEPARTAMENTO_ant150817" Then ' sistem antiguo
            ...
            '***************************************
            'se puso el 10-08-2017


        ElseIf tipo_selec_catnomin = "SEGUN DEPARTAMENTO" Then ' sistem actual
            ...
            v_nm_depa = cbodetalle.SelectedItem
            v_Zona = cboZona.SelectedItem
            v_sistema = cbodatum.SelectedItem
            pFeatureClass = pFeatureLayer_depa.FeatureClass
            Dim pqueryfilter As IQueryFilter
            pqueryfilter = New QueryFilter
            ...
            'Obteniendo el tipo de caram seleccionado

            ' sele_elemento = cbotiporese.SelectedItem

            'obteniendo el codigo del tipo de reservva
            Try
                lodbtExiste_tipo = cls_Oracle.FT_OBTIENE_TIPORESE(sele_elemento)
            Catch ex As Exception
                MsgBox("Error en Obtener los tipos de reservas de la base de datos ", MsgBoxStyle.Critical, "CONSULTA BASE DE DATOS...")
            End Try
            ...
            Do Until pFeature Is Nothing
                ...
                If v_codigo = "99" Then  'SOLO PARA MAR Y FRONTERA
                    If v_nm_depa1 = "MAR" Or v_nm_depa1 = "FUERA DEL PERU" Then
                        ...
                        ' For contador2 As Integer = 0 To lodbtExiste_tipo.Rows.Count - 1
                        For contador2 As Integer = 0 To Me.cbotiporese.Items.Count - 1
                            'sele_elemento = lodbtExiste_tipo.Rows(contador2).Item("TN_CODTIP")

                            sele_elemento = cbotiporese.Items.Item(contador2)

                            If sele_elemento = "EXPEDIENTE DE CATASTRO" Or v_nm_depa = "RESERVA TURISTICA" Or v_nm_depa = "CONCESION DE LABOR GENERAL" Or v_nm_depa = "ANAD" Or v_nm_depa = "INFRAESTRUCTURA DEL ESTADO" Then
                            Else
                                'Aqui buscar los otros tipos

                                'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, gstrFC_Departamento_Z & v_Zona, "DATA_GIS.GPO_CAR_CARAM_" & v_Zona, v_nm_depa1, sele_elemento)
                                If v_sistema = "WGS_84" Then
                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS" & v_Zona & "D", v_codigo, sele_elemento)
                                Else
                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                End If
                                ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                ...
                                Else
                                    ...
                                    If v_cantidad > 0 Then
                                        ...
                                        dRow.Item("CODIGO") = v_codigo
                                        dRow.Item("NOMBRE") = v_nm_depa1
                                        dRow.Item("TP_RESE") = sele_elemento
                                        dRow.Item("NM_TPRESE") = sele_elemento
                                        dRow.Item("AREA") = (Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString 'v_areaini_depa
                                        dRow.Item("CANTI") = v_cantidad
                                        '  dRow.Item("AREA_SUP") = v_areasup_rese
                                        ...
                                        If v_Zona = "17" Then
                                            sw.WriteLine("7P")
                                        ElseIf v_Zona = "18" Then
                                            sw.WriteLine("8P")
                                        ElseIf v_Zona = "19" Then
                                            sw.WriteLine("9P")
                                        End If
                                        ...
                                        'If v_areasup_rese > (Format(Math.Round((v_areaini_depa + v_areaini_depa), 4), "###,###.0000")) Then
                                        '    sw.WriteLine((Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString)
                                        '    sw.WriteLine(100.0)
                                        'Else
                                        ...
                                        '  Dim lostrRetorno_cuenta As String = ""
                                        '------eSTO SE COMENTO 29-08-2017 DONDE GUARDA LA INFORMACION DE AREAS NETAS A TABLAS
                    ...
                    Try
                        ...
                        For contador2 As Integer = 0 To Me.cbotiporese.Items.Count - 1
                            ...
                            Else
                                ...
                                If v_sistema = "WGS_84" Then
                                    If sele_elemento = "AREA DE DEFENSA NACIONAL" Then
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(19, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)
                                    Else
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)
                                    End If
                                    ...
                                    If v_codigo = "04" Or v_codigo = "12" Or v_codigo = "21" Or v_codigo = "05" Or v_codigo = "08" Then  '
                                        ...
                                        If v_nm_laguna = "LAGUNAS DE PUNO" Then  'SOLO PARA DPTO PUNO SUMAR SUS 3 LAGOS
                                            ...
                                            For j As Integer = 1 To 3
                                                ...
                                                If v_sistema = "WGS_84" Then
                                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_nm_laguna, sele_elemento)
                                                Else
                                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_nm_laguna, sele_elemento)
                                            ...
                                            If v_cantidad > 0 Then
                                                ...
                                                sw.WriteLine((Format(Math.Round((v_areaini_depa + v_areaini_depa2), 4), "###,###.0000")).ToString)
                                                sw.WriteLine(v_cantidad)
                                                ' If v_areasup_rese_fin > (Format(Math.Round((v_areaini_depa + v_areaini_depa2), 4), "###,###.0000")) Then
                                                'sw.WriteLine((Format(Math.Round((v_areaini_depa + v_areaini_depa2), 4), "###,###.0000")).ToString)
                                                'sw.WriteLine(100.0)
                                                'Else
                                                sw.WriteLine(v_areasup_rese_fin)
                                            ...
                                            End If
                                            'se igual para tener mismo valor del area de la region
                                        ...
                                        Else  'DIFERENTE DE PUNO, SUMAR LAGO INDIVIDUAL
                                            ...
                                            'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(54, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_nm_laguna, sele_elemento)
                                            ...
                                            If v_areasup_rese > 0.0 Then
                                                ...
                                                sw.WriteLine((Format(Math.Round((v_areaini_depa + v_areaini_depa1), 4), "###,###.0000")).ToString)
                                                sw.WriteLine(v_cantidad)
                                                'If v_areasup_rese_fin > (Format(Math.Round((v_areaini_depa + v_areaini_depa1), 4), "###,###.0000")) Then
                                                '    sw.WriteLine((Format(Math.Round((v_areaini_depa + v_areaini_depa1), 4), "###,###.0000")).ToString)
                                                '    sw.WriteLine(100.0)
                                                'Else
                                                '    sw.WriteLine(v_areasup_rese_fin)
                                        ...
                                        v_areaini_depa = v_areaini_depa + v_areaini_depa1

                                    Else  'REGIONES QUE NO TIENEN LAGUNA, ES DECIR NORMAL
                                        'VALIDA A POSIBLES ZONAS URBANAS PARA HACER PROCESO DISTINTO EN BASE A CRITERIO

                                        If sele_elemento = "POSIBLES ZONAS URBANAS" Then

                                            If v_sistema = "WGS_84" Then
                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(5, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                            Else

                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(5, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                            End If
                                            ...
                                            For contador1 As Integer = 0 To lodbtExiste_SupAR.Rows.Count - 1
                                                ...
                                                If v_cantidad > 0 Then
                                                    ...
                                                    'If v_areasup_rese > (Format(Math.Round(v_areaini_depa, 4), "###,###.0000")) Then
                                                    '    sw.WriteLine((Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString)
                                                    '    sw.WriteLine(100.0)
                                                    'Else
                                                    '    sw.WriteLine(v_areasup_rese)
                                        ...
                                        ElseIf sele_elemento = "xANAP INGEMMET" Then

                                            If v_sistema = "WGS_84" Then
                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(7, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ANAP")
                                            Else

                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(7, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ANAP")
                                            End If

                                            For contador1 As Integer = 0 To lodbtExiste_SupAR.Rows.Count - 1
                                                v_areasup_rese_inge = lodbtExiste_SupAR.Rows(contador1).Item("AREASUPER")
                                                v_codigo_depa = lodbtExiste_SupAR.Rows(contador1).Item("CODIGO")
                                                v_areaini_depa = lodbtExiste_SupAR.Rows(contador1).Item("AREAINI")
                                                v_cantidad_inge = lodbtExiste_SupAR.Rows(contador1).Item("CANTIDAD")

                                                If v_cantidad_inge > 0 Then
                                                    dRow = lodtTabla.NewRow
                                                    dRow.Item("CODIGO") = v_codigo_depa
                                                    dRow.Item("NOMBRE") = v_nm_depa1
                                                    dRow.Item("TP_RESE") = "ANAP"
                                                    dRow.Item("NM_TPRESE") = sele_elemento
                                                    dRow.Item("AREA") = (Format(Math.Round((v_areaini_depa), 4), "###,###.0000")).ToString()   'v_areaini_depa
                                                    dRow.Item("CANTI") = v_cantidad_inge
                                                    'dRow.Item("AREA_SUP") = v_areasup_rese
                                                    dRow.Item("AREA_NETA") = (Format(Math.Round((v_areasup_rese_inge), 4), "###,###.0000")).ToString()
                                                    dRow.Item("PORCEN") = (Format(Math.Round((v_areasup_rese_inge / v_areaini_depa) * 100, 2), "###,###.00")).ToString
                                                    v_porcen = (Format(Math.Round((v_areasup_rese_inge / v_areaini_depa) * 100, 2), "###,###.00")).ToString
                                                    lodtTabla.Rows.Add(dRow)
                                                    ...
                                                    'If v_areasup_rese_inge > (Format(Math.Round(v_areaini_depa, 4), "###,###.0000")) Then
                                                    '    sw.WriteLine((Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString)
                                                    '    sw.WriteLine(100.0)
                                                    'Else
                                                    '    sw.WriteLine((Format(Math.Round((v_areasup_rese_inge), 4), "###,###.0000")).ToString())
                                                    '    sw.WriteLine((Format(Math.Round((v_areasup_rese_inge / v_areaini_depa) * 100, 2), "###,###.00")).ToString)
                                                    'End If
                                        ...
                                        Else  'se puso else antes igual para que haga normal diferente a zona urbana
                                            'VALIDA ZONA URBANA QUITANDO POSIBLES ZONAS URBANAS
                                            If sele_elemento = "ZONA URBANA" Then
                                                If v_sistema = "WGS_84" Then
                                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(6, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                                Else

                                                    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(6, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                                End If
                                            End If
                                        ...
                                        End If  'se puso por el de zona urba y posible zona urbana
            ...
            Loop
            MsgBox("El Proceso ha finalizado Satisfactoriamente...", MsgBoxStyle.Exclamation, "ESTADÍSTICAS DE ÁREAS RESTRINGIDAS")
            sw.Close()
            '   Me.btnExcel.Enabled = False
        ...
        ElseIf tipo_selec_catnomin = "MINERIA A NIVEL NACIONAL" Then
            Dim valorf As String
            v_Zona = "18"
            v_codigo = "PERU"
            Dim sele_elemento As String
            Dim v_tipo_rese As String
            ' For i As Integer = 0 To Me.cbotiporese.Items.Count - 1

            'valorf = Me.cbotiporese.Items(j)
            ' MsgBox(valorf)
            ' j = j + 1

            ' Next
            'For E
            '   cbotiporese.SelectedItem
            ' cls_Catastro.PT_CargarFeatureClass_SDE("DESA_GIS.GPO_DEP_NACIONAL_WGS18", m_application, "2", False)
            ' pFeatureClass = pFeatureLayer_depa.FeatureClass
            ...
            'If v_Zona <> "18" Then
            'MsgBox("Para el cálculo de la Estadistica Nacional solo está permitido para la zona 18", MsgBoxStyle.Information, "SIGCATMIN")
            'Exit Sub
            ...
            'Do Until pFeature Is Nothing
            'v_codigo = pFeature.Value(pFeatureCursor.FindField("NOMBRE"))
            ' Dim lostrRetorno_cuenta As String
            ...
            Try
                ...
                For contador2 As Integer = 0 To Me.cbotiporese.Items.Count - 1
                    '  For i As Integer = 0 To Me.cbotiporese.Items.Count
                    ...
                    ' If sele_elemento = "EXPEDIENTE DE CATASTRO" Or sele_elemento = "RESERVA TURISTICA" Or sele_elemento = "CONCESION DE TRANSPORTE MINERO" Or sele_elemento = "CONCESION DE LABOR GENERAL" Or sele_elemento = "ANAD" Or sele_elemento = "INFRAESTRUCTURA DEL ESTADO" Or sele_elemento = "ZONA ARQUEOLOGICA" Then
                    ' Else

                    'se actualizo DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "E"   por DATA_CAT DEL CARAM   DATA_CAT.GPO_CAR_CARAM_W_18_T
                    '-----------------------1002-2022 -------------------
                    ...
                    If v_sistema = "WGS_84" Then
                        ...
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(34, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)



                        'ElseIf sele_elemento = "PROYECTO ESPECIAL - HIDRAULICOS" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(36, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "PROYECTO ESPECIAL")

                        'ElseIf sele_elemento = "AREA NATURAL - USO INDIRECTO" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(31, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "AREA NATURAL")
                        'ElseIf sele_elemento = "CLASIFICACION DIVERSA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "OTRA AREA RESTRINGIDA")
                        'ElseIf sele_elemento = "SITIO RAMSAR" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "AREA DE DEFENSA NACIONAL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "ANAP" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "ANAP INGEMMET" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "SITIO HISTORICO DE BATALLA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "PAISAJE CULTURAL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "ZONA DE RIESGO NO MITIGABLE" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "PUERTO Y/O AEROPUERTOS" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(40, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "ECOSISTEMA FRAGIL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "RESERVA INDIGENA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "RESERVA TERRITORIAL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        'ElseIf sele_elemento = "CONCESION FORESTAL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, sele_elemento)
                        ...
                        If sele_elemento = "ZONA URBANA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(34, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)

                        ElseIf sele_elemento = "PROYECTO ESPECIAL - HIDRAULICOS" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(36, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "PROYECTO ESPECIAL")

                        ElseIf sele_elemento = "AREA NATURAL - USO INDIRECTO" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(31, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "AREA NATURAL")
                        ElseIf sele_elemento = "CLASIFICACION DIVERSA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "OTRA AREA RESTRINGIDA")
                        ElseIf sele_elemento = "SITIO RAMSAR" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ElseIf sele_elemento = "AREA DE DEFENSA NACIONAL" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ElseIf sele_elemento = "ANAP" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ...
                        ElseIf sele_elemento = "ZONA DE RIESGO NO MITIGABLE" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ElseIf sele_elemento = "PUERTO Y/O AEROPUERTOS" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(40, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ElseIf sele_elemento = "ECOSISTEMA FRAGIL" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ElseIf sele_elemento = "RESERVA INDIGENA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(39, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, sele_elemento)
                        ...
                        If sele_elemento = "ZONA ARQUEOLOGICA" Then
                            'Se hace por proceso python
                        ElseIf sele_elemento = "RED VIAL NACIONAL" Then
                            'Se toma el área del total
                        Else

                            For contador1 As Integer = 0 To lodbtExiste_SupAR.Rows.Count - 1
                                v_areasup_rese = lodbtExiste_SupAR.Rows(contador1).Item("AREASUPER")
                                v_codigo_depa = lodbtExiste_SupAR.Rows(contador1).Item("NOMBRE")
                                v_areaini_depa = lodbtExiste_SupAR.Rows(contador1).Item("AREAINI")
                                v_cantidad = lodbtExiste_SupAR.Rows(contador1).Item("CANTIDAD")
                                ...
                                If v_cantidad > 0 Then
                                    dRow = lodtTabla.NewRow
                                    dRow.Item("CODIGO") = v_codigo_depa
                                    dRow.Item("NOMBRE") = v_codigo_depa
                                    dRow.Item("TP_RESE") = sele_elemento
                                    dRow.Item("NM_TPRESE") = sele_elemento
                                    dRow.Item("AREA") = (Format(Math.Round((v_areaini_depa), 4), "###,###.0000")).ToString()   'v_areaini_depa
                                    dRow.Item("CANTI") = v_cantidad
            ...
            ' Loop
            ' SE AUMENTO PPARA CASO DE ZONAS ARQUEOOOGICAS PARA HACERLO POR OTRO METODO
            ...
            If v_sistema = "WGS_84" Then
                ...
                'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", " ", "ZONA ARQUEOLOGICA")
                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, " ", "ZONA ARQUEOLOGICA")
            End If
            ...
            While RetVal Is Nothing
                '   glo_Path_EXE = "C:\BDGEOCATMIN\"
                RetVal = Shell(glo_Path_EXE & "procesoza_min.bat", 1, True)  'espera mientras termina para ejecutar siguiente linea

            End While

            ' Dim cls_catastro As New cls_DM_1
            cls_Catastro.Add_ShapeFile_tmp("za", pApp)
            Dim pFeatureClas2 As IFeatureClass
            Dim pFeaturepout2 As IFeature
            Dim pFeatureLayer2 As IFeatureLayer
            Dim v_area_f As Double
            Dim pFields2 As IFields


            pFeatureClas2 = pFeatureLayer_tmp.FeatureClass


            Dim pFeatureCursor2 As IFeatureCursor
            Dim v_area_f1 As Double = 0
            Dim v_porcen_f1 As Double = 0
            Dim v_area_f2 As Double = 0
            Dim v_area_total As Double = 0
            ...
            If pFeatureLayer_tmp.FeatureClass.FeatureCount(Nothing) > 0 Then
                ...
                pFeatureCursor2 = pFeatureClas2.Search(Nothing, False)
                pFields2 = pFeatureClas2.Fields
                pFeaturepout2 = pFeatureCursor2.NextFeature
                Do Until pFeaturepout2 Is Nothing
                    v_area_f = pFeaturepout2.Value(pFields2.FindField("F_AREA"))
                    v_area_f = Format(Math.Round(v_area_f, 4), "###,###.0000")
                    v_area_f1 = v_area_f1 + v_area_f
                    pFeaturepout2 = pFeatureCursor2.NextFeature
                Loop
                v_area_f1 = v_area_f1 / 10000

                '  v_porcen_f1 = (v_area_f1 / v_area_total) * 100
                ...
                dRow.Item("CODIGO") = v_codigo_depa
                dRow.Item("NOMBRE") = v_codigo_depa
                dRow.Item("TP_RESE") = "ZONA ARQUEOLOGICA"
                dRow.Item("NM_TPRESE") = "ZONA ARQUEOLOGICA"
                dRow.Item("AREA") = (Format(Math.Round(((v_areaini_depa)), 4), "###,###.0000")).ToString   'v_areaini_depa + v_areaini_depa1
                dRow.Item("CANTI") = v_cantidad
                ' dRow.Item("AREA_SUP") = v_areasup_rese + v_areasup_rese1
                dRow.Item("AREA_NETA") = (Format(Math.Round((v_area_f1), 4), "###,###.0000")).ToString
                dRow.Item("PORCEN") = (Format(Math.Round(((v_area_f1) / (v_areaini_depa)) * 100, 2), "###,###.00")).ToString
                ' v_porcen = (Format(Math.Round(((v_areasup_rese + v_areasup_rese1) / (v_areaini_depa + v_areaini_depa1)) * 100, 2), "###,###.00")).ToString
                'v_areasup_rese_fin = (Format(Math.Round(((v_areasup_rese + v_areasup_rese1)), 4), "###,###.0000")).ToString
                lodtTabla.Rows.Add(dRow)
                ...
                sw.WriteLine((Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString)
                sw.WriteLine(v_cantidad)
                sw.WriteLine((Format(Math.Round((v_area_f1), 4), "###,###.0000")).ToString())
                sw.WriteLine((Format(Math.Round((v_area_f1 / v_areaini_depa) * 100, 2), "###,###.00")).ToString)

            Else
                v_area_f1 = 0
                v_porcen_f1 = 0
                v_area_total = v_areaini_depa
            ...
            ' SE AUMENTO PARA HACER CASO DE RED VIALES  PARA HACERLO POR OTRO METODO
            ...
            If v_sistema = "WGS_84" Then
                ...
                ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", " ", "RED VIAL NACIONAL")
                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, " ", "RED VIAL NACIONAL")
            ...
            While RetVal1 Is Nothing
                '   glo_Path_EXE = "C:\BDGEOCATMIN\"
                RetVal1 = Shell(glo_Path_EXE & "proceso_redvial.bat", 1, True)  'espera mientras termina para ejecutar siguiente linea

            End While

            ' Dim cls_catastro As New cls_DM_1
            cls_Catastro.Add_ShapeFile_tmp("rd", pApp)
            Dim pFeatureClas3 As IFeatureClass
            Dim pFeaturepout3 As IFeature
            Dim pFeatureLayer3 As IFeatureLayer
            Dim v_area_f_3 As Double
            Dim pFields3 As IFields


            pFeatureClas3 = pFeatureLayer_tmp.FeatureClass


            Dim pFeatureCursor3 As IFeatureCursor
            Dim v_area_f1_3 As Double = 0
            Dim v_porcen_f1_3 As Double = 0
            Dim v_area_f2_3 As Double = 0
            Dim v_area_total3 As Double = 0

            If pFeatureLayer_tmp.FeatureClass.FeatureCount(Nothing) > 0 Then



                pFeatureCursor3 = pFeatureClas3.Search(Nothing, False)
                pFields3 = pFeatureClas3.Fields
                pFeaturepout3 = pFeatureCursor3.NextFeature
                Do Until pFeaturepout3 Is Nothing
                    v_area_f_3 = pFeaturepout3.Value(pFields3.FindField("F_AREA"))
                    v_area_f_3 = Format(Math.Round(v_area_f_3, 4), "###,###.0000")
                    v_area_f1_3 = v_area_f1_3 + v_area_f_3
                    pFeaturepout3 = pFeatureCursor3.NextFeature
                Loop
                v_area_f1_3 = v_area_f1_3 / 10000
                ...
                dRow.Item("CODIGO") = v_codigo_depa
                dRow.Item("NOMBRE") = v_codigo_depa
                dRow.Item("TP_RESE") = "RED VIAL NACIONAL"
                dRow.Item("NM_TPRESE") = "RED VIAL NACIONAL"
                dRow.Item("AREA") = (Format(Math.Round(((v_areaini_depa)), 4), "###,###.0000")).ToString   'v_areaini_depa + v_areaini_depa1
                dRow.Item("CANTI") = v_cantidad
                ' dRow.Item("AREA_SUP") = v_areasup_rese + v_areasup_rese1
                dRow.Item("AREA_NETA") = (Format(Math.Round((v_area_f1_3), 4), "###,###.0000")).ToString
                dRow.Item("PORCEN") = (Format(Math.Round(((v_area_f1_3) / (v_areaini_depa)) * 100, 2), "###,###.00")).ToString
                ' v_porcen = (Format(Math.Round(((v_areasup_rese + v_areasup_rese1) / (v_areaini_depa + v_areaini_depa1)) * 100, 2), "###,###.00")).ToString
                'v_areasup_rese_fin = (Format(Math.Round(((v_areasup_rese + v_areasup_rese1)), 4), "###,###.0000")).ToString
                lodtTabla.Rows.Add(dRow)
                ...
                sw.WriteLine((Format(Math.Round(v_areaini_depa, 4), "###,###.0000")).ToString)
                sw.WriteLine(v_cantidad)
                sw.WriteLine((Format(Math.Round((v_area_f1_3), 4), "###,###.0000")).ToString())
                sw.WriteLine((Format(Math.Round((v_area_f1_3 / v_areaini_depa) * 100, 2), "###,###.00")).ToString)
            ...
            '  termino
            MsgBox("El Proceso ha finalizado Satisfactoriamente..1.", MsgBoxStyle.Exclamation, "ESTADÍSTICAS DE ÁREAS RESTRINGIDAS")
            sw.Close()
            '   Me.btnExcel.Enabled = False
        ...
        ElseIf tipo_selec_catnomin = "A NIVEL NACIONAL" Then ' sistem actual


        Dim sele_elemento As String
        Dim v_tipo_rese As String
        cls_Catastro.PT_CargarFeatureClass_SDE("DESA_GIS.GPO_DEP_GENERAL_WGS18", m_application, "2", False)
        pFeatureClass = pFeatureLayer_depa.FeatureClass
        '  v_nm_depa = cbodetalle.SelectedItem
        v_Zona = cboZona.SelectedItem
        v_sistema = cbodatum.SelectedItem
        ...
        Do Until pFeature Is Nothing
            v_codigo = pFeature.Value(pFeatureCursor.FindField("NOMBRE"))
            '  v_nm_depa1 = pFeature.Value(pFeatureCursor.FindField("NOMBRE"))
            ...
            If v_codigo = "99" Then  'SOLO PARA MAR Y FRONTERA
                If v_nm_depa1 = "MAR" Or v_nm_depa1 = "FUERA DEL PERU" Then
                    ...
                    For contador2 As Integer = 0 To Me.cbotiporese.Items.Count - 1
                        ...
                        ' If sele_elemento = "EXPEDIENTE DE CATASTRO" Or v_nm_depa = "RESERVA TURISTICA" Or v_nm_depa = "CONCESION DE LABOR GENERAL" Or v_nm_depa = "ANAD" Or v_nm_depa = "INFRAESTRUCTURA DEL ESTADO" Or v_nm_depa = "ZONA ARQUEOLOGICA" Then
                        If sele_elemento = "EXPEDIENTE DE CATASTRO" Or sele_elemento = "RESERVA TURISTICA" Or sele_elemento = "CONCESION DE TRANSPORTE MINERO" Or sele_elemento = "CONCESION DE LABOR GENERAL" Or sele_elemento = "ANAD" Or sele_elemento = "INFRAESTRUCTURA DEL ESTADO" Or sele_elemento = "ZONA ARQUEOLOGICA" Then
                        ...
                        Else
                            ...
                            'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, gstrFC_Departamento_Z & v_Zona, "DATA_GIS.GPO_CAR_CARAM_" & v_Zona, v_nm_depa1, sele_elemento)
                            If v_sistema = "WGS_84" Then
                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS" & v_Zona & "D", v_codigo, sele_elemento)
                            Else
                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                            End If
                            ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(3, "DESA_GIS.GPO_DEP_DEPARTAMENTO_" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
            ...
            ElseIf v_codigo <> "99" Then  'NORMAL
                ...
                Try
                    ...
                    For contador2 As Integer = 0 To Me.cbotiporese.Items.Count - 1
                        ...
                        '   If sele_elemento = "EXPEDIENTE DE CATASTRO" Or v_nm_depa = "RESERVA TURISTICA" Or v_nm_depa = "CONCESION DE LABOR GENERAL" Or v_nm_depa = "ANAD" Or v_nm_depa = "INFRAESTRUCTURA DEL ESTADO" Or v_nm_depa = "ZONA ARQUEOLOGICA" Then
                        ' If sele_elemento = "EXPEDIENTE DE CATASTRO" Or sele_elemento = "RESERVA TURISTICA" Or sele_elemento = "CONCESION DE LABOR GENERAL" Or sele_elemento = "ANAD" Or sele_elemento = "INFRAESTRUCTURA DEL ESTADO" Or sele_elemento = "ZONA ARQUEOLOGICA" Then
                        If sele_elemento = "EXPEDIENTE DE CATASTRO" Or sele_elemento = "RESERVA TURISTICA" Or sele_elemento = "CONCESION DE TRANSPORTE MINERO" Or sele_elemento = "CONCESION DE LABOR GENERAL" Or sele_elemento = "ANAD" Or sele_elemento = "INFRAESTRUCTURA DEL ESTADO" Or sele_elemento = "ZONA ARQUEOLOGICA" Then
                        Else
                            ...
                            If v_sistema = "WGS_84" Then
                                ...
                                'Select Case sele_elemento
                                '    Case "AREA NATURAL"
                                '        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)
                                ...
                                '        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(18, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)
                                '    Case Else
                                ...
                                If sele_elemento <> "ZONA URBANA" Then
                                    ...
                                    'antes era posibles zonas urbanas
                                    ' If sele_elemento = "POSIBLES ZONAS URBANAS" Then
                                    'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(11, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ZONA URBANA")

                                    ' Else
                                    'End If
                                    'ANTES SE CAMBIO 250918 POR AREA NATURAL SE DIVIDIO EN NUCLEO Y AMORTIGUAMIENTO
                                    'lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)



                                    If sele_elemento = "AREA NATURAL" Then
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(29, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)

                                    ElseIf sele_elemento = "AMORTIGUAMIENTO" Then
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(28, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "AREA NATURAL")
                                    Else
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, sele_elemento)
                                    End If

                                    'SE TERMINO CAMBIO 250918 POR AREA NATURAL SE DIVIDIO EN NUCLEO Y AMORTIGUAMIENTO



                                Else
                                    '  MsgBox("0", MsgBoxStyle.Critical, "1")
                                    cuenta_proceso = 1
                            ...
                            Else
                                ...
                                If sele_elemento <> "ZONA URBANA" Then
                                    ...
                                    'ANTES SE CAMBIO 250918 POR AREA NATURAL SE DIVIDIO EN NUCLEO Y AMORTIGUAMIENTO
                                    ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)



                                    If sele_elemento = "AREA NATURAL" Then
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(29, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)

                                    ElseIf sele_elemento = "AMORTIGUAMIENTO" Then
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(28, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                    Else
                                        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                    End If
                                ...
                                '        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(10, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                '    Case "AREA DE DEFENSA NACIONAL"
                                '        lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(18, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, sele_elemento)
                                '    Case Else
                                'End Select
                            ...
                            End If
                            If sele_elemento <> "ZONA URBANA" Then
                                cuenta_proceso = lodbtExiste_SupAR.Rows.Count
                            Else

                            End If

                            '  If lodbtExiste_SupAR.Rows.Count = 0 Then
                            If cuenta_proceso = 0 Then
                            ...
                            Else
                                    ...
                                    If v_nm_laguna = "LAGUNAS DE PUNO" Then  'SOLO PARA DPTO PUNO SUMAR SUS 3 LAGOS
                                        ...
                                        For j As Integer = 1 To 3
                                            ...
                                            If v_sistema = "WGS_84" Then
                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, "DESA_GIS.GPO_DEP_DEPARTAMENTO_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_nm_laguna, sele_elemento)
                                            Else
                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(4, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_nm_laguna, sele_elemento)
                                ...
                                Else  'REGIONES QUE NO TIENEN LAGUNA, ES DECIR NORMAL
                                    ...
                                    'OJO ****************************
                                    'ya no pasa por aqui desde e 08 de mayo 2018- ahora es posible zona urbana como otro tipo
                                    '*********************************************************************************************

                                    If sele_elemento = "xxxxPOSIBLES ZONAS URBANAS" Then

                                        If v_sistema = "WGS_84" Then
                                            '   lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(11, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                        Else

                                            '  lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(11, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                        End If
                                    ...
                                    ElseIf sele_elemento = "xANAP INGEMMET" Then
                                        ...
                                        If v_sistema = "WGS_84" Then
                                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(13, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ANAP")
                                        Else

                                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(13, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ANAP")
                                        End If
                                    ...
                                    ElseIf sele_elemento = "AREA DE DEFENSA NACIONAL" Then
                                        ...
                                        If v_sistema = "WGS_84" Then
                                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(18, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "AREA DE DEFENSA NACIONAL")


                                        Else

                                            ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(13, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ANAP")
                                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(18, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS" & v_Zona & "D", v_codigo, "AREA DE DEFENSA NACIONAL")
                                        End If
                                        ...
                                        For contador1 As Integer = 0 To lodbtExiste_SupAR.Rows.Count - 1
                                            ...
                                            If v_cantidad_inge > 0 Then
                                                ...
                                                dRow.Item("CODIGO") = v_codigo_depa
                                                dRow.Item("NOMBRE") = v_codigo_depa
                                                dRow.Item("TP_RESE") = "AREA DE DEFENSA NACIONAL"
                                                dRow.Item("NM_TPRESE") = sele_elemento
                                                dRow.Item("AREA") = (Format(Math.Round((v_areaini_depa), 4), "###,###.0000")).ToString()   'v_areaini_depa
                                                dRow.Item("CANTI") = v_cantidad_inge
                                                'dRow.Item("AREA_SUP") = v_areasup_rese
                                    ...
                                    Else  'se puso else antes igual para que haga normal diferente a zona urbana
                                        ...
                                        If sele_elemento = "ZONA URBANA" Then
                                            If v_sistema = "WGS_84" Then
                                                ...
                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(12, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                            Else

                                                lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(12, "DESA_GIS.GPO_DEP_GENERAL_WGS" & v_Zona, "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", v_codigo, "ZONA URBANA")
                                            End If
                                        End If
        ...
        Loop
        ' SE AUMENTO PARA HACER POR DEPARTAMENTOS A ZONAS ARQUEOOOGICAS


        'If tipo_selec_catnomin = "x_zonaarqueologica" Then


        ' MsgBox("termino primera parte", MsgBoxStyle.Critical, "gis")
        ...
        If v_sistema = "WGS_84" Then
            ...
            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DESA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona & "D", " ", "ZONA ARQUEOLOGICA")
        Else

            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DESA_GIS.GPO_CAR_CARAM_" & v_Zona & "D", " ", "ZONA ARQUEOLOGICA")
        End If
        ...
        While RetVal Is Nothing
            '   glo_Path_EXE = "C:\BDGEOCATMIN\"
            RetVal = Shell(glo_Path_EXE & "procesoza.bat", 1, True)  'espera mientras termina para ejecutar siguiente linea
        ...
        'ElseIf tipo_selec_catnomin = "A NIVEL NACIONAL" Then   'comentado el 17-11-17  
        ...
        '                            sw.WriteLine(v_codigo)
        '                            ' sw.WriteLine(v_areaini_depa + v_areaini_depa2)
        '                            sw.WriteLine(v_areaini_depa2)
        '                            sw.WriteLine(v_cantidad)
        '                            ' sw.WriteLine(v_areasup_rese + v_areasup_rese2)
        '                            sw.WriteLine(v_areasup_rese2)
        '                            'sw.WriteLine((Format(Math.Round(((v_areasup_rese + v_areasup_rese2) / (v_areaini_depa + v_areaini_depa2)) * 100, 2), "###,###.00")).ToString)
        '                            sw.WriteLine((Format(Math.Round(((v_areasup_rese2) / (v_areaini_depa2)) * 100, 2), "###,###.00")).ToString)
        ...
        For r As Integer = 0 To dt.Rows.Count - 1
            ...
            'End Select
        Next
        ' MsgBox(v_areaini_depa, MsgBoxStyle.Critical, "x")

        'aplica al totoal de area

        txtArea1.Text = Format(v_areaini_depa, "###,###,###,###.####")
        'txtArea2.Text = Format(s2, "###,###,###,###.####")
        ' txtPorcentaje.Text = Format((s2 / v_areaini_depa) * 100, "###,###,###,###.##")

        If (s2 >= Format(v_areaini_depa, "###,###,###,###.####")) Then   'cuando es mayor el area neta al area de la region
            txtArea2.Text = Format(v_areaini_depa, "###,###,###,###.####")
            txtPorcentaje.Text = Format(100, "###,###,###,###.##")
        Else
            txtArea2.Text = Format(s2, "###,###,###,###.####")
            txtPorcentaje.Text = Format((s2 / v_areaini_depa) * 100, "###,###,###,###.##")
        End If
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        ElseIf tipo_selec_catnomin = "MINERIA A NIVEL NACIONAL" Then
            RetVal = Shell(glo_Path_EXE & "procesareportemineria.bat", 1)
        End If
    ...
    Private Sub btn_mineriasi_Click(sender As Object, e As EventArgs) Handles btn_mineriasi.Click
        tipo_casomin = "SI"
        pMap = pMxDoc.FocusMap
        Me.btnExcel.Enabled = True
        Dim pFeature As IFeature
        ...
        ruta = glo_Path & "reporteMIN.txt"
        ruta1 = glo_Path & "reportearqMIN.txt"
        ...
        If tipo_selec_catnomin = "MINERIA A NIVEL NACIONAL" Then
            Dim valorf As String
            v_Zona = "18"
            v_codigo = "PERU"
            Dim sele_elemento As String
            ...
            Try
                ...
                For contador2 As Integer = 0 To Me.cbotiporesemin.Items.Count - 1

                    sele_elemento = cbotiporesemin.Items.Item(contador2)
                    ...
                    If v_sistema = "WGS_84" Then
                        ...
                        'Proceso antiguo
                        'ANTES DE 030418
                        'If sele_elemento = "AREA NATURAL - AMORTIGUAMIENTO" Then

                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(32, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "AREA NATURAL")

                        'ElseIf sele_elemento = "PROYECTO ESPECIAL (no hidráulicos)" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(37, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "PROYECTO ESPECIAL")

                        'ElseIf sele_elemento = "AREA NATURAL - USO DIRECTO" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(30, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "AREA NATURAL")
                        'ElseIf sele_elemento = "CLASIFICACION DIVERSA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(41, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "OTRA AREA RESTRINGIDA")
                        'ElseIf sele_elemento = "PROPUESTA DE AREA NATURAL" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(38, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "PROPUESTA DE AREA NATURAL")
                        'ElseIf sele_elemento = "AREA DE CONSERVACION PRIVADA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(42, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "AREA NATURAL")
                        'ElseIf sele_elemento = "AREA DE CONSERVACION MUNICIPAL Y OTROS" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(43, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "AREA NATURAL")
                        'ElseIf sele_elemento = "POSIBLE ZONA URBANA" Then

                        'ElseIf sele_elemento = "AREA DE EXPANSION URBANA" Then
                        '    lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(35, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", v_codigo, "ZONA URBANA")
                        ...
                        If sele_elemento = "AREA NATURAL - AMORTIGUAMIENTO" Then
                            ...
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(32, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "AREA NATURAL")

                        ElseIf sele_elemento = "PROYECTO ESPECIAL (no hidráulicos)" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(37, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "PROYECTO ESPECIAL")

                        ElseIf sele_elemento = "AREA NATURAL - USO DIRECTO" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(30, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "AREA NATURAL")
                        ElseIf sele_elemento = "CLASIFICACION DIVERSA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(41, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "OTRA AREA RESTRINGIDA")
                        ElseIf sele_elemento = "PROPUESTA DE AREA NATURAL" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(38, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "PROPUESTA DE AREA NATURAL")
                        ElseIf sele_elemento = "AREA DE CONSERVACION PRIVADA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(42, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "AREA NATURAL")
                        ElseIf sele_elemento = "AREA DE CONSERVACION MUNICIPAL Y OTROS" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(43, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "AREA NATURAL")
                        ElseIf sele_elemento = "POSIBLE ZONA URBANA" Then

                        ElseIf sele_elemento = "AREA DE EXPANSION URBANA" Then
                            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(35, "DESA_GIS.GPO_DEP_NACIONAL_WGS_" & v_Zona, "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, v_codigo, "ZONA URBANA")

                        End If

                        If sele_elemento = "POSIBLE ZONA URBANA" Then
                            'Se hace por proceso python
        ...
        If v_sistema = "WGS_84" Then
            ...
            ' lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_CAT.GPO_CAR_CARAM_W_" & v_Zona & "_ET", " ", "POSIBLE ZONA URBANA")
            lodbtExiste_SupAR = cls_Oracle.FT_Int_tiporesexdepa(14, " ", "DATA_GIS.GPO_CAR_CARAM_WGS_" & v_Zona, " ", "POSIBLE ZONA URBANA")
        End If
        ...
        While RetVal Is Nothing
            '   glo_Path_EXE = "C:\BDGEOCATMIN\"
            RetVal = Shell(glo_Path_EXE & "proceso_pu.bat", 1, True)  'espera mientras termina para ejecutar siguiente linea

        End While

        ' Dim cls_catastro As New cls_DM_1
        cls_Catastro.Add_ShapeFile_tmp("pu", pApp)
        Dim pFeatureClas2 As IFeatureClass
        Dim pFeaturepout2 As IFeature
        Dim pFeatureLayer2 As IFeatureLayer
        Dim v_area_f As Double
        ...
        If pFeatureLayer_tmp.FeatureClass.FeatureCount(Nothing) > 0 Then
            ...
            dRow.Item("CODIGO") = v_codigo_depa
            dRow.Item("NOMBRE") = v_codigo_depa
            dRow.Item("TP_RESE") = "POSIBLE ZONA URBANA"
            dRow.Item("NM_TPRESE") = "POSIBLE ZONA URBANA"
            dRow.Item("AREA") = (Format(Math.Round(((v_areaini_depa)), 4), "###,###.0000")).ToString   'v_areaini_depa + v_areaini_depa1
            dRow.Item("CANTI") = v_cantidad
            ' dRow.Item("AREA_SUP") = v_areasup_rese + v_areasup_rese1
            dRow.Item("AREA_NETA") = (Format(Math.Round((v_area_f1), 4), "###,###.0000")).ToString
    ...
    Private Sub btnExcel_Click_1(sender As Object, e As EventArgs) Handles btnExcel.Click
        ...
        'RetVal2 = Shell(glo_Path_EXE & "Procesototal_Ar.bat", 1)

        'End While

        Dim v_areaini_depa As Double
        Dim v_areaini_neta As Double

        ' Dim cls_catastro As New cls_DM_1
        cls_Catastro.Add_ShapeFile_tmp("caramd6", pApp)
        Dim pFeatureClas2 As IFeatureClass
        Dim pFeaturepout2 As IFeature
        Dim pFeatureLayer2 As IFeatureLayer
        Dim v_area_f As Double
        ...
        txtArea2.Text = Format(v_area_f1, "###,###,###,###.####")
        txtPorcentaje.Text = Format((v_area_f1 / v_areaini_depa) * 100, "###,###,###,###.##")
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If tipo_selec_catnomin = "MINERIA A NIVEL NACIONAL" Then
            If tipo_casomin = "NO" Then
                RetVal = Shell(glo_Path_EXE & "procesareportemineriaNo.bat", 1)
            ElseIf tipo_casomin = "SI" Then
                RetVal = Shell(glo_Path_EXE & "procesareportemineriaSi.bat", 1)
            End If
    ...
    Private Sub btnbaachero_Click(sender As Object, e As EventArgs) Handles btnbaachero.Click
        Application.DoEvents()
        Dim RetVal2
    ...
    Private Sub btnneto_Click(sender As Object, e As EventArgs) Handles btnneto.Click
        Application.DoEvents()
        Dim RetVal2

        While RetVal2 Is Nothing

            RetVal2 = Shell(glo_Path_EXE & "proceso_calculomar.bat", 1)

        End While
    End Sub

  
    Private Sub btnexceltotal_Click(sender As Object, e As EventArgs) Handles btnexceltotal.Click
        Dim RetVal
        tipo_selec_catnomin = "neto"

        RetVal = Shell(glo_Path_EXE & "copycapamar.bat", 1)

        Application.DoEvents()
        Dim RetVal2
        ruta2 = glo_Path & "reporteneto.txt"
        Dim sw2 As New System.IO.StreamWriter(ruta2)
        ' While RetVal2 Is Nothing
        '   RetVal2 = Shell(glo_Path_EXE & "procesocopycapas.bat", 1)

        'nd While

        valida = True
        glo_pathTMP = glo_proceso
        cls_Catastro.Add_ShapeFile1("caram_disolve", pApp, "caram")
        ...
        Dim v_area_f_tot As Double = 0
        Dim v_areaini_depa As Double = 0
        Dim v_area_f As Double = 0
        If valida = True Then
            pFeatureLayer1 = pMap.Layer(0)
            ...
            'pFeatureClass = pFeatureLayer.FeatureClass
            'pFeatureClass = pFeatureLayer.FeatureClass
            pFeatureCursor1 = pFeatureClass1.Search(Nothing, False)
            pFields1 = pFeatureClass1.Fields
            ' Dim v_area_f_tot As Double = 0
            pfeature1 = pFeatureCursor1.NextFeature
            Do Until pfeature1 Is Nothing
                v_area_f = pfeature1.Value(pFields1.FindField("POLY_AREA"))
                v_area_f = Format(Math.Round(v_area_f, 4), "###,###.0000")
                v_area_f_tot = v_area_f_tot + v_area_f
            ...
            txttierra.Text = v_area_f_tot
            '  v_areaini_depa = 129429265.356

            v_areaini_depa = 129429265.356
            sw2.WriteLine(v_area_f_tot)
            sw2.WriteLine((Format(Math.Round((v_area_f_tot / v_areaini_depa) * 100, 2), "###,###.00")).ToString)
            'borrando la capa
            pMap.DeleteLayer(pFeatureLayer1)
            ...
            Dim pFields2 As IFields
            cls_Catastro.Add_ShapeFile1("caram_mar", pApp, "carammar")
            Dim v_area_martot As Double = 0
            Dim v_area_mar As Double = 0
            If valida = True Then
                pFeatureLayer2 = pMap.Layer(0)
                pFeatureClass2 = pFeatureLayer2.FeatureClass

                pFeatureCursor2 = pFeatureClass2.Search(Nothing, False)
                pFields2 = pFeatureClass2.Fields
                ' Dim v_area_f_tot As Double = 0
                pfeature2 = pFeatureCursor2.NextFeature
                Do Until pfeature2 Is Nothing
                    v_area_mar = pfeature2.Value(pFields2.FindField("F_AREA"))
                    v_area_mar = v_area_mar / 10000
                    v_area_mar = Format(Math.Round(v_area_mar, 4), "###,###.0000")

                    v_area_martot = v_area_martot + v_area_mar

                    pfeature2 = pFeatureCursor2.NextFeature
                Loop

                txtmar.Text = v_area_martot
                sw2.WriteLine(v_area_martot)
                ' sw2.WriteLine((Format(Math.Round((v_area_martot / v_areaini_depa) * 100, 2), "###,###.00")).ToString)

            End If
            'borrando la capa
            pMap.DeleteLayer(pFeatureLayer2)
        ...
        RetVal = Shell(glo_Path_EXE & "procesareporteneto.bat", 1)


    End Sub

   
    Private Sub btncapas_Click(sender As Object, e As EventArgs) Handles btncapas.Click
        glo_pathTMP = glo_proceso
        cls_Catastro.Add_ShapeFile1("caram_disolve", pApp, "caram")
        cls_Catastro.Add_ShapeFile1("caram_mar", pApp, "carammar")

        MsgBox("Se añadieron las capas del resultado del cálculo de áreas netas..", MsgBoxStyle.Exclamation, "Proceso de Cálculo área neta")

...
Public Class Frm_Eval_segun_codigo
    ...
    Private Const Col_Vigcat = 2
    Private Const Col_Zona = 3
    Private Const Col_Tipo = 4
    Private Const Col_Estado = 5
    Private Const Col_Naturaleza = 6
    Private Const Col_Carta = 7
    Private Const Col_Hectarea = 8
    ...
    Private Sub Frm_Eval_segun_codigo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lbl_reporte_libden.Enabled = False
        lbl_reporte_libden.Visible = False
        pbox_reporte_dm_libden.Enabled = False
        pbox_reporte_dm_libden.Enabled = False
        pbox_reporte_dm_libden.Visible = False
        pbox_reporte_dm_libden_int.Enabled = False
        pbox_reporte_dm_libden_int.Visible = False
        ...
        If glo_int_Perfil <> 0 Then
            ...
            If m_form.DialogResult = Windows.Forms.DialogResult.OK Or gloint_Acceso = "1" Then
                ...
                'dRow8 = lodtbCboTipo.NewRow
                'dRow8.Item("CODIGO") = "OP_32"
                'dRow8.Item("DESCRIPCION") = "DM Renuncia"
                'lodtbCboTipo.Rows.Add(dRow8)

                ''nuevo(OP - 33)
                'Dim dRow9 As DataRow
                'dRow9 = lodtbCboTipo.NewRow
                'dRow9.Item("CODIGO") = "OP_33"
                'dRow9.Item("DESCRIPCION") = "DM Porcentaje Ubicación"
                'lodtbCboTipo.Rows.Add(dRow9)

                ''nuevo(OP - 34)
                'Dim dRow10 As DataRow
                'dRow10 = lodtbCboTipo.NewRow
                'dRow10.Item("CODIGO") = "OP_34"
                'dRow10.Item("DESCRIPCION") = "DM UEAs"
                'lodtbCboTipo.Rows.Add(dRow10)
            ...
            dt_secpub = cls_Oracle.FT_DATA_ACCEDITARIO("", tipo)      'Seleccion que se muestra en pantalla inicial (AR  v  LR)
    ...
    Public Sub Inicializar_Variable_Global()
        ...
        Try
            ...
            Else
                MsgBox("Conexión al Servidor SIGGeocatmin Error ... ", MsgBoxStyle.Information, "[SIGCATMIN]")
                Exit Sub
            End If
        ...
        Try
            lodtbData = cls_Oracle.FT_SEL_LISTA_DESCRIPCION("2", "CARAM_SRV")
            If lodtbData.Rows.Count > 1 Then
                ruta_rese = lodtbData.Rows(0).Item("DESCRIPCION")
                ruta_procesado = lodtbData.Rows(1).Item("DESCRIPCION")
                ruta_IMAGENES = lodtbData.Rows(2).Item("DESCRIPCION")

            Else
                MsgBox("Conexión A RUTA DEL CARAM ... ", MsgBoxStyle.Information, "[SIGCATMIN]")
                Exit Sub
            End If
    ...
    Private Sub Inicializa_Layer_DM(ByVal p_Tipo As String)
        Select Case p_Tipo
            Case "OP_7", "OP_10", "OP_8", "OP_13"
                ...
                Me.clbLayer.Items.Add("Caram")
                Me.clbLayer.Items.Add("Catastro Forestal")
                'Me.clbLayer.Items.Add("Concesion Forestal")   '@@ch
            ...
            Case "OP_2", "OP_1", "OP_18"
                ...
                Me.clbLayer.Items.Add("Caram")
                Me.clbLayer.Items.Add("Catastro Forestal")
                'Me.clbLayer.Items.Add("Concesion Forestal")  
                Me.clbLayer.Items.Add("Limite Departamental")
                Me.clbLayer.Items.Add("Limite Provincial")
                Me.clbLayer.Items.Add("Limite Distrital")
                Me.clbLayer.Items.Add("Centros Poblados")
            ...
            Case "OP_12", "OP_11"
                ...
                Me.clbLayer.Items.Add("Caram")
                Me.clbLayer.Items.Add("Catastro Forestal")
                Me.clbLayer.Items.Add("Predio Rural")
                'Me.clbLayer.Items.Add("Concesion Forestal")   
                Me.clbLayer.Items.Add("Limite Departamental")
                Me.clbLayer.Items.Add("Limite Provincial")
                Me.clbLayer.Items.Add("Limite Distrital")
                ...
                Me.clbLayer.SetItemCheckState(1, Windows.Forms.CheckState.Indeterminate)
                'Me.clbLayer.SetItemCheckState(2, Windows.Forms.CheckState.Indeterminate)
                'Me.clbLayer.SetItemCheckState(3, Windows.Forms.CheckState.Unchecked)
            Case "OP_3", "OP_9"
                'Me.clbLayer.Items.Add("Zona Reservada")
                'Me.clbLayer.Items.Add("Area Urbana")
                Me.clbLayer.Items.Add("Caram")
            ...
            Case Else
                'Me.clbLayer.Items.Add("Zona Reservada")
                'Me.clbLayer.Items.Add("Area Urbana")
                Me.clbLayer.Items.Add("Caram")   ' se agrega
                Me.clbLayer.SetItemCheckState(0, Windows.Forms.CheckState.Indeterminate)
                'Me.clbLayer.SetItemCheckState(1, Windows.Forms.CheckState.Indeterminate)
                'Me.clbLayer.SetItemCheckState(2, Windows.Forms.CheckState.Indeterminate)    ' se agrega
        End Select
        'Me.clbLayer.SetItemCheckState(0, Windows.Forms.CheckState.Indeterminate)
        'Me.clbLayer.SetItemCheckState(1, Windows.Forms.CheckState.Indeterminate)
    ...
    Private Sub txtConsulta_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtConsulta.KeyPress
        ...
        v_opcion_modulo = Me.cbo_tipo.SelectedValue
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        MensajeHablado.Speak("Buscando Derecho minero")          '("Buscando Derecho minero " & Me.txtConsulta.Text)

        MsgBox("Prueba de W10 en W11...", MsgBoxStyle.Critical, "SIGCATMIN")
        ...
        If cbo_tipo.SelectedValue = "OP_32" Then
            v_opcion_modulo = "OP_32"
            Try
                Kill(glo_pathTMP & "\Renuncia.shp")
                Kill(glo_pathTMP & "\Renuncia.dbf")
                Kill(glo_pathTMP & "\Renuncia.shx")
                Kill(glo_pathTMP & "\Renuncia.prj")
                Kill(glo_pathTMP & "\Renuncia.sbn")
                Kill(glo_pathTMP & "\Renuncia.sbx")
            Catch ex As Exception

            End Try
        End If

        If cbo_tipo.SelectedValue = "OP_11" Then
            v_opcion_modulo = "OP_11"
        End If
        ...
        If v_sistema = "PSAD-56" Then
            ...
            'gstrFC_forestal = "GPO_CFO_CATASTRO_FORESTAL_P"     '@@@ch
            gstrFC_forestal = "GPO_SERFOR_CONCESIONES_P"
        ...
        ElseIf v_sistema = "WGS-84" Then
            ...
            ' gstrFC_forestal = "GPO_CFO_CATASTRO_FORESTAL_W"      '@@@ch
            gstrFC_forestal = "GPO_SERFOR_CONCESIONES_W"
        ...
        Select Case Me.cbo_tipo.SelectedValue 'tipo_seleccion
            Case "OP_7", "OP_10", "OP_8"
                ...
                Me.clbLayer.SetItemCheckState(0, Windows.Forms.CheckState.Indeterminate)   'id 838
                'Me.clbLayer.SetItemCheckState(1, Windows.Forms.CheckState.Indeterminate)   'id 838
                'Me.clbLayer.SetItemCheckState(2, Windows.Forms.CheckState.Indeterminate)
            ...
            Case "OP_13"
                ...
                cls_Catastro.Expor_Tema(loStrShapefile, True, m_Application)  '@CQ
                ...
                If v_bloqueo_dm = "0" Then

                    cls_Prueba.Poligono_Color_1("Catastro", lodtbLeyenda, glo_pathStyle & "\Catastro.style", "LEYENDA", "", m_Application)
                ElseIf v_bloqueo_dm = "1" Then
                    cls_Prueba.Poligono_Color_1("Catastro", lodtbLeyenda, glo_pathStyle & "\Catastro.style", "LEYENDA", "", m_Application)
                End If
            ...
            Case "OP_11", "OP_2", "OP_5", "OP_6", "OP_16", "OP_18", "OP_19", "OP_20", "OP_29", "OP_30", "OP_32"
                ...
                If tipo_seleccion = "OP_11" Or tipo_seleccion = "OP_2" Or tipo_seleccion = "OP_18" Or tipo_seleccion = "OP_20" Or tipo_seleccion = "OP_29" Or tipo_seleccion = "OP_30" Or tipo_seleccion = "OP_32" Then
                ...
                ElseIf cbo_tipo.SelectedValue = "OP_30" Then
                    ...
                    'Select Case Me.cboConsulta.SelectedIndex + 1
                    '    Case 1
                    '        v_codigo_dm = txtConsulta.Text
                    '    Case 2
                    '        v_nombre_dm = txtConsulta.Text
                    'End Select

                    Dim tipo_ac As String
                    If Me.cboConsulta.SelectedIndex = 0 Then

                        tipo_ac = "1"
                        v_codigo_dm = txtConsulta.Text
                        lodbListaValDM = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, v_nombre_dm, tipo_ac)
                        ...
                        End Select
                        Try
                            v_nombre_dm = lodbListaValDM.Rows(0).Item("NOMBRE").ToString
                            v_codigo_dm = lodbListaValDM.Rows(0).Item("CODIGO").ToString
                        Catch ex As Exception
                        End Try
                    Else
                        tipo_ac = "2"
                ...
                ElseIf cbo_tipo.SelectedValue = "OP_32" Then
                    'Dim tipo_ac As String = "9"
                    'lodbListaValDM = cls_Oracle.FT_DATA_ACUMULACION(txtConsulta.Text, tipo_ac)
                    'Select Case lodbListaValDM.Rows.Count
                    '    Case 0
                    '        MsgBox("No Existe ningún Registo de Renuncia con esta consulta " & txtConsulta.Text, MsgBoxStyle.Information, "[SIGCATMIN]")
                    '        Exit Sub
                    'End Select

                    ' Se agrega 20/04/2023
                    Dim tipo_ac As String
                    If Me.cboConsulta.SelectedIndex = 0 Then
                        tipo_ac = "1"
                        v_codigo_dm = txtConsulta.Text
                        lodbListaValDM = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, v_nombre_dm, tipo_ac)
                ...
                ElseIf cbo_tipo.SelectedValue = "OP_30" Then
                    ...
                    lodbListaDM = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, v_nombre_dm, tipo_ac)
                    Try
                        v_hectadiv = lodbListaDM.Rows(0).Item("HECTAREA").ToString
                    Catch ex As Exception
                    End Try
                ElseIf cbo_tipo.SelectedValue = "OP_32" Then
                    Dim tipo_ac As String = "12"
                    lodbListaDM = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, v_nombre_dm, tipo_ac)
                    Try
                        v_hectadiv = lodbListaDM.Rows(0).Item("HECTAREA").ToString
                    Catch ex As Exception
                ...
                Else
                    ...
                    v_codigo = Me.txtConsulta.Text

                    Try
                        p_grafica1 = lodbListaDM.Rows(0).Item("PE_VIGCAT").ToString
                    Catch ex As Exception

                    End Try
                    'p_grafica1 = lodbListaDM.Rows(0).Item("PE_VIGCAT").ToString
                    '    pbox_reporte_dm_libden_Click()
                End If
                ...
                Select Case lodbListaDM.Rows.Count
                    Case 0
                        ...
                        DialogResult = Windows.Forms.DialogResult.Cancel
                    Case Else
                        ''If lodbListaDM.Rows(0).Item("PE_VIGCAT") <> "G" Then
                        ''    MsgBox("El DM consultado:  " & txtConsulta.Text & "  No esta Graficando", MsgBoxStyle.Information, "[SIGCATMIN]")
                        ''    DialogResult = Windows.Forms.DialogResult.Cancel
                        ''    Exit Select
                        ''End If
                        ...
                        Try
                            ...
                            vzona = lodbListaDM.Rows(0).Item("ZONA") 'Se agrega 07042021
                        Catch ex As Exception
    ...
    Private Sub btnGraficar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGraficar.Click
        ...
        Select Case cbo_tipo.SelectedValue
            Case "OP_11" 'Evaluación
                ...
                GloInt_Opcion = 1
            Case "OP_12", "OP_29", "OP_30", "OP_32" 'Simulacion / Acumulación / División / Renuncia
                conta_botones_evaluacion = conta_botones_evaluacion + 1
                GloInt_Opcion = 1
            Case "OP_5" 'carta ign
                conta_botones_evaluacion = conta_botones_evaluacion + 1
        ...
        Select Case Me.cbo_tipo.SelectedValue
            ...
            Case "OP_7", "OP_10", "OP_8"
                ...
                Catch ex As Exception
                End Try
            Case "OP_12", "OP_29", "OP_30", "OP_32"  'simulacion
                ...
                If Me.cboZona.SelectedIndex = 0 Then
                    MsgBox("Seleccione la Zona en que desea Graficar la consulta ..", MsgBoxStyle.Information, "[BDGEOCATMIN]")
                    Me.cboZona.Focus()
                    Exit Sub
                End If
                ...
                'If cbo_tipo.SelectedValue = "OP_12" Or cbo_tipo.SelectedValue = "OP_30" Or cbo_tipo.SelectedValue = "OP_32" Then
                '    v_nombre = v_nombre_dm
                '    v_nombre_dm = "DM_Simulado"
                '    'v_codigo = v_codigo_dm
                '    'v_codigo = "000000001"
                'End If
                ...
                ElseIf v_opcion_modulo = "OP_32" Then
                    cls_catastro.Quitar_Layer("Renuncia", m_Application)
                End If
            ...
            Case "OP_16" 'LIBRE DENUNCIABILIDAD 
                ...
                'lbl_reporte_libden.Enabled = True
                'lbl_reporte_libden.Visible = True
                'pbox_reporte_dm_libden.Enabled = True
                'pbox_reporte_dm_libden.Enabled = True
                'pbox_reporte_dm_libden.Visible = True
                'pbox_reporte_dm_libden_int.Enabled = True
                'pbox_reporte_dm_libden_int.Visible = True
            ...
            Case "OP_11", "OP_2", "OP_18", "OP_20" 'EVALUACION (11) Y CONSULTA (02)
                ...
                If tipo_seleccion = "OP_11" Or tipo_seleccion = "OP_18" Or tipo_seleccion = "OP_20" Then
                    ...
                    Select Case v_vigcat
                        Case "G"
                            Dim v_coddat As String
                            v_coddat = cls_Oracle.FT_verifica_datumdm(v_codigo)
                        ...
                        Case Else
                            ...
                            ElseIf v_sistema = "WGS-84" Then
                                ...
                                gstrFC_CARAM = "GPO_CAR_CARAM_WGS_"     '@dd
                    ...
                    Select Case loglo_MensajeDM
                        ...
                        Case "6"
                            ...
                            ElseIf v_sistema = "WGS-84" Then
                                ...
                                'gstrFC_AReservada = "CEGO0891.RESEW_"     
            ...
            Case "OP_29", "OP_30", "OP_32"   ' ACUMULACION, DIVISION, RENUNCIA
    ...
    Private Sub visualizar_datos_dm(ByVal p_consulta As String, ByVal p_App As IApplication)
        ...
        Select Case Me.cbo_tipo.SelectedValue
            ...
            Case Else
                If v_sistema = "PSAD-56" Then  'PROCEDIMIENTO PARA OBTENER DM EN DATUN 56
                    ...
                    ElseIf cbo_tipo.SelectedValue = "OP_30" Then        ' Aqui se debe capturar la fila seleccionada del datagrid y el valor del campo NOMBRE
                        Dim tipo_ac As String = "4"

                        If kuentadiv = 0 Then
                            lodtbDatos = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, v_nombre_dm, tipo_ac)
                            kuentadiv = kuentadiv + 1
                        Else
                            'Cuenta_int = dgdDetalle.Row
                            'Dim nom = dgdDetalle.Item(dgdDetalle.Row, "nombre")  ---> ejemplo de captura del campo NOMBRE de la fila seleccionada

                            lodtbDatos = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, "", "9")
                            v_nombre_dm = lodtbDatos.Rows(dgdDetalle.Row).Item("NOMBRE").ToString     ' dgdDetalle.Row --> capturo la fila seleccionada del datagrid
                    ...
                    ElseIf cbo_tipo.SelectedValue = "OP_32" Then
                        ...
                        If kuentarenun = 0 Then
                            lodtbDatos = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, v_nombre_dm, tipo_ac)
                            kuentarenun = kuentarenun + 1
                        Else
                            'Cuenta_int = dgdDetalle.Row
                            'Dim nom = dgdDetalle.Item(dgdDetalle.Row, "nombre")  ---> ejemplo de captura del campo NOMBRE de la fila seleccionada

                            lodtbDatos = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, "", "9")
                            v_nombre_dm = lodtbDatos.Rows(dgdDetalle.Row).Item("NOMBRE").ToString     ' dgdDetalle.Row --> capturo la fila seleccionada del datagrid
        ...
        Select Case lodtbDatos.Rows.Count
            ...
            Case Else
                ...
                If cbo_tipo.SelectedValue = "OP_29" Or cbo_tipo.SelectedValue = "OP_30" Or cbo_tipo.SelectedValue = "OP_32" Then        'SE ESTA AGREGANDO "OP_30"
                ...
                ElseIf cbo_tipo.SelectedValue = "OP_30" Then
                    v_nombre_dm = lodtbDatos.Rows(0).Item("PE_NOMDER").ToString
                    'v_equivalente = "01"
                    v_equivalente = lodtbDatos.Rows(0).Item("DD_CODDAT").ToString
                    v_titular_dm = lodtbDatos.Rows(0).Item("TITULAR").ToString
                    v_codigo = lodtbDatos.Rows(0).Item("CG_CODIGO").ToString
                    v_zona_dm = (lodtbDatos.Rows(0).Item("PE_ZONCAT").ToString)
                    v_carta_dm = lodtbDatos.Rows(0).Item("CA_CODCAR").ToString
                ...
                'ElseIf cbo_tipo.SelectedValue = "OP_32" Then
                '    fecha_archi_sim = DateTime.Now.Ticks.ToString()
                '    Dim p_shapefile As String = "Renuncia" & fecha_archi_sim & ""
                ...
                If cbo_tipo.SelectedValue = "OP_29" Or cbo_tipo.SelectedValue = "OP_30" Or cbo_tipo.SelectedValue = "OP_32" Then
                    fecha_archi_sim = DateTime.Now.Ticks.ToString()
                    Dim p_shapefile As String = ""
                    If cbo_tipo.SelectedValue = "OP_29" Then
                        p_shapefile = "Acumulacion" & fecha_archi_sim & ""
                    ElseIf cbo_tipo.SelectedValue = "OP_30" Then
                        p_shapefile = "Division" & fecha_archi_sim & ""
                    ElseIf cbo_tipo.SelectedValue = "OP_32" Then
                        p_shapefile = "Renuncia" & fecha_archi_sim & ""
                    End If
                    cls_eval.Geoprocesamiento_temas_convert("FCToShp", p_App, p_shapefile)
                    cls_Catastro.ClearLayerSelection(pFeatureLayer)
                    cls_Catastro.Quitar_Layer(p_shapefile, p_App)
                ...
                If v_opcion_modulo = "OP_29" Or v_opcion_modulo = "OP_30" Or v_opcion_modulo = "OP_32" Then
        ...
        Next
        If v_opcion_modulo = "OP_30" Then
            Dim tipo_ac As String = "12"
            'lodtbDatosdiv = cls_Oracle.P_SEL_DATOS_DM_DIVISION(p_consulta, v_nombre_dm, tipo_ac)
            lodtbDatosdiv = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, v_nombre_dm, tipo_ac)  '12092022
            v_codidiv = lodtbDatosdiv.Rows(0).Item("CODIGO").ToString
            v_concediv = lodtbDatosdiv.Rows(0).Item("NOMBRE").ToString
      
        ElseIf v_opcion_modulo = "OP_32" Then
            Dim tipo_ac As String = "12"
            lodtbDatosdiv = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, v_nombre_dm, tipo_ac)
            'v_codidiv = lodtbDatosdiv.Rows(0).Item("CODIGO").ToString
            'v_concediv = lodtbDatosdiv.Rows(0).Item("NOMBRE").ToString
            'Try
            '    v_hectadiv = lodtbDatosdiv.Rows(0).Item("HECTAREA").ToString
            'Catch ex As Exception

            'End Try
            v_codigo_dm = lodtbDatosdiv.Rows(0).Item("CODIGO").ToString
            v_nombre = lodtbDatosdiv.Rows(0).Item("NOMBRE").ToString
            v_tipo_renun = lodtbDatosdiv.Rows(0).Item("TIPOAREA").ToString

            If v_tipo_renun = "RN" Then
                area_renuncia = "RENUNCIADA"
            ElseIf v_tipo_renun = "RT" Then
                area_renuncia = "RETENIDA"
            End If

        End If

        ' Se comenta 20/04/2023

        'If v_opcion_modulo = "OP_32" Then
        '    Dim tipo_ac As String = "7"
        '    lodtbDatosren = cls_Oracle.FT_DATA_ACUMULACION(p_consulta, tipo_ac)
        'End If
    ...
    Private Sub cbo_tipo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_tipo.SelectedIndexChanged
        ...
        Dim nombreModulo = cbo_tipo.SelectedItem(1).ToString()
        requestInteraction(nombreModulo)
        ...
        Select Case cbo_tipo.SelectedValue
            Case "OP_11", "OP_2", "OP_18" 'Evaluación, consulta dm
                ...
                btnRepAvisoRet.Visible = False
                btnRepAvisoRet.Enabled = False
            ...
            Case "OP_16" 'libre denunciabilidad
                ...
                btnRepAvisoRet.Visible = True
                btnRepAvisoRet.Enabled = True

                cboConsulta.Enabled = False
                cboConsulta.Visible = False
                Label12.Visible = True
                gbxDatosGenerales.Visible = True
                gbxDatosGenerales.Enabled = True

                btnReporte.Visible = False
                btnReporte.Enabled = False
                btnOtraConsulta.Visible = False
                btnOtraConsulta.Enabled = False
                lbl_Previo.Visible = False
                lbl_Previo.Enabled = False
                clbLayer.Visible = False
                clbLayer.Enabled = False
                lstCoordenada.Visible = False
                lstCoordenada.Enabled = False
                ...
                'Me.lblConsultar.Text = "Consultar"
                'Me.lblDato.Text = "Dato"
                Me.Cbo_libdenu.Enabled = False : Cbo_libdenu.Visible = False
                txtConsulta.Visible = False : txtConsulta.Enabled = False
                Me.lbt_dato1.Visible = False : Me.lbt_dato1.Enabled = False
                Me.lbt_dato2.Visible = False : Me.lbt_dato2.Enabled = False
                Me.lbt_dato3.Visible = False : Me.lbt_dato3.Enabled = False
                Me.lbt_dato4.Visible = False : Me.lbt_dato4.Enabled = False
            ...
            Case "OP_1", "OP_14", "OP_28" '    CARTA DM
                ...
                txtRadio.Enabled = False
                txtdato1.Visible = True : txtdato1.Enabled = False
                txtdato2.Visible = True : txtdato2.Enabled = False
                txtdato3.Visible = True : txtdato3.Enabled = False
                txtdato4.Visible = True : txtdato4.Enabled = False
                lstCoordenada.Visible = False
                btnGraficar.Enabled = False
                txtRadio.Enabled = False
                cboZona.Enabled = False
            ...
            Case "OP_23"  'Reporte DM superpuestos
                ...
                Dim pForm As New frm_DMSuperpuestoDia
            ...
            Case "OP_48"  'Titulares_DM PPM/PMA'

                Dim pForm As New frm_PPM_PMA
            ...
            Case "OP_26"
                ...
                'Dim pForm1 As New frm_ingreso_obraspublicas
                'Dim pform1 As New frm_prevaluacioon_reg
            ...
            Case "OP_27" 'CONSULTAR AREA RESTRINGIDA
                seleccion_opcion = "consulta_arearestringida"
                Me.lbl_lista.Visible = False : Me.lbl_lista.Enabled = False
                lst_listadm.Enabled = False
                lst_listadm.Visible = False
                btn_cargarcuadriculas.Visible = False
            ...
            Case "OP_29", "OP_32"  'DM Acumulacion, DM Renuncia
            ...
            Case "OP_33"
                ...
                Dim pForm2 As New frmPorcentajeUbicacion

                pForm2.m_application = m_Application
                pForm2.StartPosition = Windows.Forms.FormStartPosition.CenterScreen
                pForm2.ShowDialog()
                SetWindowLong(pForm2.Handle.ToInt32(), GWL_HWNDPARENT, m_Application.hWnd)
                'pForm2.Show()

            Case "OP_34"  'DM UEAs

                Dim ueas_form As New form_ueas
                ueas_form.m_application = m_Application
                ueas_form.StartPosition = Windows.Forms.FormStartPosition.CenterScreen
                Me.Close()
                'ueas_form.ShowDialog()
                ueas_form.Show()    '>>>>  SE COMENTA PARA PROBAR
                ...
                'Me.cboConsulta.SelectedIndex = 0
            Case "OP_35"
                '  Dim uar_form As New Frm_Ingreso_AreasRestringidas
                ' uar_form.papp = m_Application
                ' uar_form.StartPosition = FormStartPosition.CenterScreen
                ' Me.Close()
                'uar_form.Show()


                Dim uar_form As New form_mantenimiento_areas_restringidas
                uar_form.papp = m_Application
                uar_form.StartPosition = FormStartPosition.CenterScreen
                Me.Close()
                uar_form.Show()
            ...
            Case "OP_47"  'Area Disponible DM 
                ...
                Dim pForm As New frm_AreaDisponible
    ...
    Private Sub PT_Forma_Grilla_DM()
        ...
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Tipo).Width = 50
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Naturaleza).Width = 70
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Hectarea).Width = 70
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Estado).Width = 40
        Me.dgdDetalle.Splits(0).DisplayColumns(Col_Vigcat).Width = 70
        ...
        Me.dgdDetalle.Columns("TIPO").Caption = "Tipo_ex"
        ...
        Me.dgdDetalle.Columns("PE_VIGCAT").Caption = "Est_Graf"

        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Codigo).Width = 80
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Codigo).Width = 70 '  80
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Nombre).Width = 150  '150
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Vigcat).Width = 70   '40
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Zona).Width = 40
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Tipo).Width = 50 '40
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Estado).Width = 40
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Naturaleza).Width = 70   '65
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Carta).Width = 45
        'Me.dgdDetalle.Splits(0).DisplayColumns(Col_Hectarea).Width = 70 '55
    ...
    Private Sub dgdDetalle_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgdDetalle.DoubleClick
        ...
        If cbo_tipo.SelectedValue = "OP_30" Then
            Dim dtlistaDM As DataTable
            dtlistaDM = cls_Oracle.P_SEL_DATOS_DM_DIVISION(v_codigo_dm, "", "9")
            Me.dgdDetalle.DataSource = dtlistaDM

            'Me.dgdDetalle.DataSource = lodbListaValDM   ' prueba

            'Se agrega para mostrar registro seleccionado en el datagrid
            RemoveHandler Me.dgdDetalle.RowColChange, AddressOf dgdDetalle_RowColChange
            Me.dgdDetalle.Row = Cuenta_int
            AddHandler Me.dgdDetalle.RowColChange, AddressOf dgdDetalle_RowColChange
        End If

        If cbo_tipo.SelectedValue = "OP_32" Then
            Dim dtlistaDM As DataTable
            dtlistaDM = cls_Oracle.P_SEL_DATOS_DM_RENUNCIA(v_codigo_dm, "", "9")

            'v_codigo_dm = dtlistaDM.Rows(0).Item("CODIGO").ToString
            'v_nombre = dtlistaDM.Rows(0).Item("NOMBRE").ToString
            'v_tipo_renun = dtlistaDM.Rows(0).Item("TIPO").ToString
    ...
    Private Sub btnReporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReporte.Click
        ...
        If controw > 0 Then
            ...
            If v_equivalente = v_sistema Then       'datum origen del DM es igual al datum seleccionado
                If v_sistema = "WGS-84" Then
                    m_ReportDefinitionFile = glo_pathREP & "rpt_ReporteN84.xml"
                Else
                    m_ReportDefinitionFile = glo_pathREP & "rpt_ReporteN56.xml"
                End If
            Else
                If v_sistema = "WGS-84" Then
                    m_ReportDefinitionFile = glo_pathREP & "rpt_Reporte2N84.xml"
                Else
                    m_ReportDefinitionFile = glo_pathREP & "rpt_Reporte2N56.xml"
                End If
            End If
        ...
        Else
            ...
            If v_equivalente = v_sistema Then       'datum origen del DM es igual al datum seleccionado
                If v_sistema = "WGS-84" Then
                    m_ReportDefinitionFile = glo_pathREP & "rpt_ReporteN_84.xml"
                Else
                    m_ReportDefinitionFile = glo_pathREP & "rpt_ReporteN_56.xml"
                End If
            Else
                If v_sistema = "WGS-84" Then
                    m_ReportDefinitionFile = glo_pathREP & "rpt_Reporte2N_84.xml"
                Else
                    m_ReportDefinitionFile = glo_pathREP & "rpt_Reporte2N_56.xml"
                End If
            End If
            ...
            Select Case glostrNaturaleza
                ...
                Case "N"
                    frm_Rpt.C1Report1.Fields("NATURALEZA").Text = "No Metálico"
            End Select
            frm_Rpt.C1Report1.Fields("HECTAREA_C").Text = Area_utm                  'lostrHaGIS
            'frm_Rpt.C1Report1.Fields("PARTIDA").Text = glostrPartida
            'frm_Rpt.C1Report1.Fields("PADRON").Text = glostrPadron
            'frm_Rpt.C1Report1.Fields("JEFATURA").Text = glostrJefatura
            'frm_Rpt.C1Report1.Fields("TIPO_DERECHO").Text = glostrTipoDer
    ...
    Public Sub Activar_Capas_DM(ByVal p_Filtro_Capital As String, ByVal p_clbLayer As Object, ByVal p_Zona As String)
        Try
                ...
                Select Case p_clbLayer.CheckedItems.Item(i) '.SelectedItem '.GetItemText(i) clbLayer.CheckedItems.Item(1)
                    ...
                    Case "Zona Reservada"
                        ...
                        If tipo_opcion = "2" Or tipo_opcion = "3" Then  'Solo si es consulta por Areas Restringida
                            ...
                            If cod_opcion_Rese = "AN" Then  'Solo capas Reservas se agrega ya no capas Urbanas
                                ...
                                If seleccion_opcion = "consulta_arearestringida" Then

                                    cls_Catastro.Add_ShapeFile1("Zona Reservada" & fecha_archi, m_Application, "Zona Reservada1")
                                    cls_Catastro.Color_Poligono_Simple(m_Application, "Zona Reservada1")
                                    cls_Catastro.rotulatexto_dm("Zona Reservada1", m_Application)
                                Else
                                    cls_Catastro.Add_ShapeFile1("Zona Reservada" & fecha_archi, m_Application, "Zona Reservada")
                                    ' cls_Catastro.Shade_Poligono("Zona Reservada", m_Application)
                                    cls_Catastro.Color_Poligono_Simple(m_Application, "Zona Reservada")
                    ...
                    Case "Caram"
                        ...
                        If tipo_opcion = "2" Or tipo_opcion = "3" Then  'Solo si es consulta por Areas Restringida
                            ...
                            If cod_opcion_Rese = "AN" Then  'Solo capas Reservas se agrega ya no capas Urbanas
                                ' cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_AReservada & p_Zona, m_Application, "1", False)
                                cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_CARAM & p_Zona, m_Application, "1", False)

                                If v_valida_canti_rese = "1" Then
                                    cls_Catastro.DefinitionExpression(cadena_query_ar_corre, m_Application, "Caram")  'cuando clase tiene muchos espacios vacioes
                                Else
                                    cls_Catastro.DefinitionExpression(cadena_query_ar, m_Application, "Caram")
                                End If

                                cls_Catastro.Expor_Tema("Caram", True, m_Application)
                                cls_Catastro.Quitar_Layer("Caram", m_Application)

                                If seleccion_opcion = "consulta_arearestringida" Then

                                    ' cls_Catastro.Add_ShapeFile1("Caram" & fecha_archi, m_Application, "Caram1")
                                    ' cls_Catastro.Color_Poligono_Simple(m_Application, "Caram1")
                                    ' cls_Catastro.rotulatexto_dm("Caram1", m_Application)
                                    Dim lo_Filtro As String = ""
                                    Dim lodtbLeyenda As New DataTable

                                    cls_Catastro.Add_ShapeFile1("Caram" & fecha_archi, m_Application, "Caram")
                                    ' cls_Catastro.Update_Value_Layer(m_Application, "Caram", "Caram")  'player, tema        '@caram
                                    lodtbLeyenda = cls_Prueba.f_Genera_Leyenda_DM("Caram", lo_Filtro, m_Application)
                                    cls_Prueba.Poligono_Color_1("Caram", lodtbLeyenda, glo_pathStyle & "\Caram1.style", "ESTILO", "", m_Application)    '@caram    Caram.style
                                    cls_Catastro.rotulatexto_dm("Caram", m_Application)


                                Else
                                    '  cls_Catastro.Add_ShapeFile1("Caram" & fecha_archi, m_Application, "Caram")
                                    'cls_Catastro.Color_Poligono_Simple(m_Application, "Caram")
                                    ' cls_Catastro.rotulatexto_dm("Caram", m_Application)
                                    ...
                                    cls_Catastro.Add_ShapeFile1("Caram" & fecha_archi, m_Application, "Caram")
                                    'cls_Catastro.Update_Value_Layer(m_Application, "Caram", "Caram")  'player, tema
                                    lodtbLeyenda = cls_Prueba.f_Genera_Leyenda_DM("Caram", lo_Filtro, m_Application)
                                    cls_Prueba.Poligono_Color_1("Caram", lodtbLeyenda, glo_pathStyle & "\Caram1.style", "ESTILO", "", m_Application)
                                    cls_Catastro.rotulatexto_dm("Caram", m_Application)
                        ...
                        Else
                            Dim lo_Filtro_Caram As String = ""
                            If tipo_seleccion = "OP_7" Or tipo_seleccion = "OP_10" Or tipo_seleccion = "OP_8" Then
                                cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_CARAM & p_Zona, m_Application, "2", False)     ' se cambia de  1  a  2
                                'lo_Filtro_Caram = "1"
                                'cls_Prueba.Intersect_Dema_AreaRestringida(m_Application, lo_Filtro_Ubigeo, "", lo_layer, xMin, yMin, xMax, yMax, txtExiste)  'se comenta

                                lo_Filtro_Caram = cls_Catastro.f_Intercepta_FC("Caram", glo_xMin, glo_yMin, glo_xMax, glo_yMax, m_Application)
                                cantidad_reg_areas = 1

                            Else
                                If V_caso_simu = "SI" Then
                                    cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_CARAM & p_Zona, m_Application, "2", False)
                                    lo_Filtro_Caram = cls_Catastro.f_Intercepta_FC("Caram", v_dato1, v_dato2, v_dato3, v_dato4, m_Application)
                                    cantidad_reg_areas = 1
                                Else
                                    cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_CARAM & p_Zona, m_Application, "2", False)
                                    lo_Filtro_Caram = cls_Catastro.f_Intercepta_FC("Caram", glo_xMin, glo_yMin, glo_xMax, glo_yMax, m_Application)
                            ...
                            Else
                                ...
                                'cls_Catastro.Add_ShapeFile_tmp("Caram" & fecha_archi, m_Application, "Caram")
                                Try
                                    Kill(glo_pathTMP & "\*.sbn")
                                    Kill(glo_pathTMP & "\*.sbx")
                                ...
                                cls_Catastro.Add_ShapeFile1("Caram" & fecha_archi, m_Application, "Caram")
                                'cls_eval.agregacampotema_tpm("Caram", "Caram")
                                'cls_Catastro.Update_Value_Layer(m_Application, "Caram", "Caram")  'player, tema     '@caram
                                lodtbLeyenda = cls_Prueba.f_Genera_Leyenda_DM("Caram", lo_Filtro, m_Application)
                                cls_Prueba.Poligono_Color_1("Caram", lodtbLeyenda, glo_pathStyle & "\Caram1.style", "ESTILO", "", m_Application)
                                'cls_Catastro.Color_Poligono_Simple(m_Application, "Caram")
                                ...
                                ''''''''''''''''''''''''''''
                                'If v_opcion_modulo = "OP_12" Then

                                '    fecha_archi = DateTime.Now.Ticks.ToString
                                '    Dim capa_output As String = "caram_sim" & fecha_archi
                                '    Dim capa_input As String = "Caram"
                                '    Dim capa_over As String = "Simulado"
                                '    Dim geoproceso As String = "clip"
                                '    cls_eval.Geoprocesamiento_temas2(capa_output, m_Application, capa_input, capa_over, geoproceso)
                                '    cls_Catastro.Add_ShapeFile_tmp(capa_output, m_Application)
                                '    cls_Catastro.Add_ShapeFile(capa_output, m_Application)
                                '    cls_Catastro.Update_Value_Layer(m_Application, "caram_sim", "caram_sim")  'genera los valores lista_caramur, lista_caramre
                                '    cls_Catastro.Quitar_Layer("caram_sim", m_Application)
                                '    cls_Catastro.Quitar_Layer("Simulado", m_Application)
                                'ElseIf v_opcion_modulo = "OP_29" Or v_opcion_modulo = "OP_30" Or v_opcion_modulo = "OP_32" Then
                                '    cls_Catastro.Quitar_Layer("Simulado", m_Application)
                                'End If
                                '''''''''''''''''''''''
                    ...
                    Case "Catastro Forestal"
                        ...
                        If tipo_seleccion = "OP_11" Then
                            ...
                            '''''' se agrega para FA de la capa Concesiones de SERFOR '''''
                            Try
                                Dim vconcesion_serfor As String = cls_Oracle.P_INS_SG_D_EVALGISDM(p_Zona, v_sistema, v_codigo, gstrUsuarioAcceso)
                            Catch ex As Exception

                            End Try
                            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''

                            cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_forestal & p_Zona, m_Application, "1", False)   '''@@@ch
                            ...
                            If lo_Filtro_forestal = "" Then
                                ...
                                'cls_Catastro.Quitar_Layer("Concesion Forestal", m_Application)     '@@ch
                            Else
                                ...
                                'cls_Catastro.DefinitionExpression(lo_Filtro_forestal, m_Application, "Concesion Forestal")     '@@ch
                                'cls_Catastro.Color_Poligono_Simple(m_Application, "Concesion Forestal")
                                'cls_Catastro.rotulatexto_dm("Concesion Forestal", m_Application)
                            End If
                        End If
                    ...
                    Case "Predio Rural"
                        ...
                        'cls_eval.DefinitionExpressiontema(lista_depa_sele, m_Application, "Departamento")
                    ...
                    Case "Red Vial"
                        If v_filtro = 0 Then  'valida <> 99
                            ...
                            cls_Catastro.UniqueSymbols(m_Application, "Vias")
                            'cls_Catastro.Shade_Poligono("Vias", m_Application)   ---> no es polígono
                        End If
            ...
            If valida_urb_shp = "1" Then
                'cls_eval.AddLayerFromFile_ZU(m_Application)
                cls_eval.AddLayerFromFile_frontera(m_Application)
            End If
    ...
    Private Sub btnGenera_Poligono_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenera_Poligono.Click
        ...
        Try
            ...
            ''comentado
            '' SE AGREGA CODIGO PARA GENERAR EL POLIGONO SIMULADO
            ''fecha_archi = DateTime.Now.Ticks.ToString()
            'Dim p_shapefile As String = "DM_Simulado"
            'cls_eval.Geoprocesamiento_temas_convert("FCToShp", m_Application, p_shapefile)   ' @CE
            ''cls_Catastro.Add_ShapeFile_tmp(loStrShapefile, m_Application)
            ''cls_Catastro.Add_ShapeFile(loStrShapefile, m_Application)
            'cls_Catastro.ClearLayerSelection(pFeatureLayer)
    ...
    Private Sub Cbo_libdenu_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cbo_libdenu.SelectedIndexChanged
        ...
        ElseIf Cbo_libdenu.Text = "Masivo" Then
            ...
            Else
                ...
                Me.cboZona.Location = New System.Drawing.Point(326, 113)
                Me.lblZona.Location = New System.Drawing.Point(326, 98)
                ...
                Me.lbl_Previo.Visible = False : Me.lbl_Previo.Enabled = False
                ...
                clbLayer.Visible = False : clbLayer.Enabled = False
    ...
    Private Sub btn_procesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_procesar.Click
        ...
        Select Case Me.cbo_tipo.SelectedValue
            ...
            Case "OP_22"    'Demarcacion INEI
                ...
                Dim RetVal
                While RetVal Is Nothing   ' Agrega registros a las capas de acceditarios    U:\DATOS\SHAPE\regiones\process\P01_limites_regionales
                    'glo_Path_EXE = "U:\DATOS\SHAPE\regiones\data2013_CM\input\"
                    glo_Path_EXE = "U:\DATOS\SHAPE\regiones\process\P01_limites_regionales\"
                    'RetVal = Shell(glo_Path_EXE & "dema2013.bat", 1)
                    RetVal = Shell(glo_Path_EXE & "execute.bat", 1)
                End While

                MsgBox("Pulsar el botón: Cargar cuadrículas", MsgBoxStyle.Information, "Aviso")
                Me.btn_cargarcuadriculas.Enabled = True
            ...
            Case "OP_46"    'DMs Conforman UEAs
                ...
                fecha_archi = DateTime.Now.Ticks.ToString()
                Dim anno As String = "2007"
                v_zona_dm = "18"

                dt_DataUEA = cls_Oracle.FT_DM_UEAS(anno)

                If dt_DataUEA.Rows.Count > 0 Then
                    For contador As Integer = 0 To dt_DataUEA.Rows.Count - 1
                        coduea = dt_DataUEA.Rows(contador).Item("CG_CODIGO")
                        v_codigo = dt_DataUEA.Rows(contador).Item("CG_CODPET")
                        If contador = 0 Then
                            lista_codigo = "CODIGOU =  '" & v_codigo & "'"
                        ElseIf contador > 0 Then
                            lista_codigo = lista_codigo & " OR " & "CODIGOU =  '" & v_codigo & "'"
                        End If
                    Next contador

                    gstrFC_Catastro_Minero = "GPO_CMI_CATASTRO_MINERO_WGS_"
                    cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_Catastro_Minero & v_zona_dm, m_Application, "1", False)
                    cls_eval.consultacapaDM("", "dmintuea", "Catastro")
                    cls_Catastro.Expor_Tema("dmintuea" & fecha_archi, sele_denu, m_Application)
                    cls_Catastro.Add_ShapeFile_tmp("dmintuea" & fecha_archi, m_Application)
                    cls_Catastro.Add_ShapeFile("dmintuea" & fecha_archi, m_Application)
                    cls_eval.agregacampotema_tpm("cata_uea", "cata_uea") 'Agrega campo 
                    cls_Catastro.Update_Value_Layer(m_Application, "cata_uea", "cata_uea")

                    cls_Catastro.Layer_TableSort(m_Application, "dmintuea" & fecha_archi, "dmintueas" & fecha_archi, "CODI_UEA")

                    cls_Catastro.Quitar_Layer("Catastro", m_Application)  'quita la capa
                    cls_Catastro.Quitar_Layer("cata_uea", m_Application)  'quita la capa
                    ...
                    'Dim RetVal
                    'While RetVal Is Nothing   ' COPIA LOS ACCEDITARIOS POR ZONA Y POR DATUM EN LA CARPETA:  "C:\BDGEOCATMIN\Temporal\Acceditario\"
                    ...
                    'Dim RetVal1
                    'While RetVal1 Is Nothing   ' CONSOLIDADO DE LAS CAPAS DE ACCEDITARIOS EN LA CARPETA:  "C:\BDGEOCATMIN\Temporal\Acceditario\"
                    '    'glo_Path_EXE = "C:\BDGEOCATMIN\Temporal\Acceditario\"
                    ...
                    'cls_Catastro.Borra_Todo_Feature("", m_Application)
                    MsgBox("Proceso Terminado de DMs en UEAs...", MsgBoxStyle.Exclamation, "SIGCATMIN")
                    Exit Sub
                Else
                    MsgBox("No existen DM integrantes de las UEAs...", MsgBoxStyle.Critical, "SIGCATMIN")
                    Exit Sub
                End If
            ...
            Case "OP_16"        'LIBRE DENUNCIABILIDAD
                ...
                Try
                    ...
                    Dim v_insert As String = ""
                    Dim v_update As String = ""
                    Dim v_tipo As String = "1"
                    Dim codi_are As String
                    Dim update_ld As String = ""
                    Dim upd_desres As String = ""
                    'Dim table_libden_libre As String = ""
                    'Dim table_libden_intersec As String = ""

                    Dim ins_tabla As String
                    Dim v_delete As String


                    Dim RetVal = Shell(glo_Path & "\estilos\Barra_Proceso.exe", 1)
                    v_delete = cls_Oracle.FT_DEL_LIBREDEN()
                    ''####### Ejecutar generacion de reportes evaluados de libre denunciabilidad ####
                    'generar_reporte_evaluacion_libre_denu()
                    'cls_Eval.cierra_ejecutable()
                    ...
                    If v_sistema = "PSAD-56" Then
                        ...
                        Try
                            Kill("C:\BDGEOCATMIN\Temporal\Libredenu\PSAD_56\*.*")       '@ce
                        Catch ex As Exception
                        ...
                        Dim nombretabla As String = "listadodm56"
                        Dim ruta As String = "C:\BDGEOCATMIN\Temporal\Libredenu"
                        Dim proceso As String = "listado56"

                        ' Lee el listado .dbf
                        'cls_catastro.Leer_dbf_libredenu(nombretabla, ruta, proceso)
                        cls_catastro.Leer_datos_libredenu(proceso)

                        Dim codigo56 As String = ""
                        Dim arrayDM56 = listadm56.Distinct.ToArray

                        For j As Integer = 0 To arrayDM56.length - 1
                            codigo56 = arrayDM56(j).ToString

                            ' Inserta en la tabla de BD el listado .dbf
                            Try
                                ins_tabla = cls_Oracle.FT_INST_DM_LIBDEN(codigo56)
                            Catch ex As Exception
                        ...
                        Try
                            ' Actualiza la tabla de BD con los DMs que se intersectan (capa catastro)
                            v_update = cls_Oracle.FT_UPD_CM_LIBREDEN(v_sistema)
                        Catch ex As Exception

                        End Try
                        'v_update = cls_Oracle.FT_UPD_CM_LIBREDEN()
                        ...
                        For i As Integer = 17 To 19
                            ...
                            ' lista de DM de la tabla, que no estan intersectados (campo LD_CODINT is null)
                            dt_ARElibreden = cls_Oracle.FT_ARE_LIBRE_DENUN(v_equivalente, v_zona_dm, v_tipo)

                            If dt_ARElibreden.Rows.Count > 0 Then

                                For contador As Integer = 0 To dt_ARElibreden.Rows.Count - 1
                                    codi_are = dt_ARElibreden.Rows(contador).Item("CG_CODIGO")
                                    If contador = 0 Then
                                        lista_codigo_are = "CODIGOU =  '" & codi_are & "'"
                                    ElseIf contador > 0 Then
                                        lista_codigo_are = lista_codigo_are & " OR " & "CODIGOU =  '" & codi_are & "'"
                                    End If
                                Next contador

                                cls_catastro.PT_CargarFeatureClass_SDE(gstrFC_Catastro_Minero & v_zona_dm, m_Application, "1", False)
                                cls_catastro.Actualizar_DM(v_zona_dm)
                                cls_Eval.consultacapaDM("", "libredenun", "Catastro")

                                arch_cata = "Libreden"
                                cls_catastro.Exportando_Temas("", "Catastro", m_Application)     'pApp
                                cls_catastro.Quitar_Layer("Catastro", m_Application)

                                cls_catastro.Add_ShapeFile_tmp("Libreden" & fecha_archi, m_Application)
                                cls_catastro.Add_ShapeFile("Libreden" & fecha_archi, m_Application)

                                'cls_catastro.PT_CargarFeatureClass_SDE(gstrFC_AReservada & v_zona_dm, m_Application, "1", False)
                                'cls_catastro.Actualizar_DM(v_zona_dm)
                                'Dim capa_input As String = "Zona Reservada"
                                'Dim capa_over As String = "Libreden"
                                'Dim capa_output As String = "rese_dm_" & fecha_archi

                                'cls_Eval.Geoprocesamiento_temas_interseccion1(capa_output, m_Application, capa_input, capa_over)     'pApp
                                'cls_catastro.Quitar_Layer("Zona Reservada", m_Application)

                                'cls_catastro.Add_ShapeFile_tmp("rese_dm_" & fecha_archi, m_Application)
                                'cls_catastro.Add_ShapeFile("rese_dm_" & fecha_archi, m_Application)
                                'cls_catastro.Update_Value_Layer(m_Application, "rese_dm_int", "rese_dm_int")

                                'cls_catastro.PT_CargarFeatureClass_SDE(gstrFC_ZUrbana & v_zona_dm, m_Application, "1", False)
                                'cls_catastro.Actualizar_DM(v_zona_dm)
                                'capa_input = "Zona Urbana"
                                'capa_over = "Libreden"
                                'capa_output = "urba_dm_" & fecha_archi

                                'cls_Eval.Geoprocesamiento_temas_interseccion1(capa_output, m_Application, capa_input, capa_over)     'pApp
                                'cls_catastro.Quitar_Layer("Zona Urbana", m_Application)

                                'cls_catastro.Add_ShapeFile_tmp("urba_dm_" & fecha_archi, m_Application)
                                'cls_catastro.Add_ShapeFile("urba_dm_" & fecha_archi, m_Application)
                                'cls_catastro.Update_Value_Layer(m_Application, "urba_dm_int", "urba_dm_int")


                                ''''''''''''''''''' Caram  ''''''''''''''''''''''''''
                                cls_catastro.PT_CargarFeatureClass_SDE(gstrFC_CARAM & v_zona_dm, m_Application, "1", False)
                                cls_catastro.Actualizar_DM(v_zona_dm)
                                Dim capa_input As String = "Caram"
                                Dim capa_over As String = "Libreden"
                                Dim capa_output As String = "caram_dm_" & fecha_archi

                                cls_Eval.Geoprocesamiento_temas_interseccion1(capa_output, m_Application, capa_input, capa_over)
                                cls_catastro.Quitar_Layer("Caram", m_Application)

                                cls_catastro.Add_ShapeFile_tmp("caram_dm_" & fecha_archi, m_Application)
                                cls_catastro.Add_ShapeFile("caram_dm_" & fecha_archi, m_Application)
                                cls_catastro.Update_Value_Layer(m_Application, "caram_dm_int", "caram_dm_int")
                                ''''''''''''''

                                Dim codigo_ld As String = ""
                                Dim arrARE = listadmARE.Distinct.ToArray
                                For j As Integer = 0 To arrARE.length - 1
                                    codigo_ld = arrARE(j).ToString

                                    ' Actualiza en la tabla, el campo LD_CODINT con 'R' los DM que se intersectan con las capas rese y urba
                                    update_ld = cls_Oracle.FT_UPD_LIBREDEN(codigo_ld)
                                Next
                            End If
                        Next
                    Else
                        ...
                        Try
                            Kill("C:\BDGEOCATMIN\Temporal\Libredenu\WGS_84\*.*")        '@ce
                        Catch ex As Exception
                        ...
                        Dim nombretabla As String = "listadodm84"
                        Dim ruta As String = "C:\BDGEOCATMIN\Temporal\Libredenu"
                        Dim proceso As String = "listado84"

                        'cls_catastro.Leer_dbf_libredenu(nombretabla, ruta, proceso)     ''*****
                        cls_catastro.Leer_datos_libredenu(proceso)

                        Dim codigo84 As String = ""
                        Dim arrayDM84 = listadm84.Distinct.ToArray
                        'Dim ins_tabla As String
                        For j As Integer = 0 To arrayDM84.length - 1
                            codigo84 = arrayDM84(j).ToString

                            Try
                                ins_tabla = cls_Oracle.FT_INST_DM_LIBDEN(codigo84)
                            Catch ex As Exception
                        ...
                        For i As Integer = 17 To 19
                            ...
                            If dt_ARElibreden.Rows.Count > 0 Then
                                ...
                                arch_cata = "Libreden"
                                cls_catastro.Exportando_Temas("", "Catastro", m_Application)
                                cls_catastro.Quitar_Layer("Catastro", m_Application)
                                ...
                                'Dim listadm_ares As String = ""
                                'Dim arrARE = listadmARE.Distinct.ToArray
                                'For j As Integer = 0 To arrARE.length - 1
                                '    listadm_ares = arrARE(j).ToString & "," & listadm_ares
                                'Next
                                'listadm_ares = listadm_ares.TrimEnd(",")
                    ...
                    ' lista tabla sg_t_sig_dmlibden con campo ld_codint is null
                    dt_DMlibreden = cls_Oracle.FT_SEL_TOT_LIBRE_DENUN("1")

                    ' Crea .dbf de los DMs libres (sin intersección)
                    Dim libden_libre As String = "libden_libre_" & v_equivalente & "_" & fecha_archi
                    cls_catastro.creatabla_dbf(libden_libre)

                    ' lista tabla sg_t_sig_dmlibden con campo ld_codint con C y R
                    dt_DMlibreden = cls_Oracle.FT_SEL_TOT_LIBRE_DENUN("2")

                    ' Crea .dbf de los DMs que se intersectan
                    Dim libden_intersec As String = "libden_intersec_" & v_equivalente & "_" & fecha_archi
                    cls_catastro.creatabla_dbf(libden_intersec)
            ...
            Case "OP_31" 'Mantenimiento DM_Acceditario
                ...
                v_dmacceditario = cls_Oracle.FT_DATA_ACCEDITARIO(v_secpub, tipo)       'Numero de DM que pasaran a capa Acceditario (estado  H)
                    ...
                    For datum As Integer = 1 To 2
                        For i As Integer = 17 To 19
                            ...
                            If datum = 1 Then
                                ...
                                cls_Catastro.Add_ShapeFile_tmp("Accedi_p" & i, m_Application)
                            ...
                            Else
                                ...
                                cls_Catastro.Add_ShapeFile_tmp("Accedi_w" & i, m_Application)
                ...
                'antes el proceso de cesar q el cual tambien hace lo mismo en pc 02-08-18
                ...
                'If v_dmacceditario.Rows.Count > 0 Then
                '    For contador As Integer = 0 To v_dmacceditario.Rows.Count - 1
                '        codi_acced = v_dmacceditario.Rows(contador).Item("LD_CODCAT")  ' se cambio de campo
                '        If contador = 0 Then
                '            lista_codigo_acce = "CODIGOU =  '" & codi_acced & "'"
                '        ElseIf contador > 0 Then
                '            lista_codigo_acce = lista_codigo_acce & " OR " & "CODIGOU =  '" & codi_acced & "'"
                ...
                '            If datum = 1 Then
                '                gstrFC_Catastro_Minero = "GPO_CMI_CATASTRO_MINERO_"
                '                cls_Catastro.PT_CargarFeatureClass_SDE(gstrFC_Catastro_Minero & v_zona_dm, m_Application, "2", False)  'sin cargarla la capa
                '                ' cls_eval.consultacapaDM("", "Acceditario", "Catastro")
                '                cls_eval.consultacapaDM("Acceditario", "Acceditario", "Catastro")
                '                cls_Catastro.Expor_Tema("Accedi_p" & i, sele_denu, m_Application)
                '                '  cls_Catastro.ClearLayerSelection(pFeatureLayer)
                '                '  cls_Catastro.Add_ShapeFile("Accedi_p" & i & fecha_archi, m_Application)
                '                cls_Catastro.Add_ShapeFile("Accedi_p" & i, m_Application)
                '                cls_eval.agregacampotema_tpm("Acceditario", "Acceditario") 'Agrega campo 
                '                cls_Catastro.Update_Value_acceditario(m_Application, "Acceditario")  'registra fecha
                '                cls_Catastro.Quitar_Layer("Acceditario", m_Application)  'quita la capa
                ...
                '                cls_Catastro.Expor_Tema("Accedi_w" & i, sele_denu, m_Application)
                '                ' cls_Catastro.ClearLayerSelection(pFeatureLayer)
                '                '  cls_Catastro.Add_ShapeFile("Accedi_w" & i & fecha_archi, m_Application)
                '                cls_Catastro.Add_ShapeFile("Accedi_w" & i, m_Application)
                '                cls_eval.agregacampotema_tpm("Acceditario", "Acceditario") 'Agrega campo 
                '                cls_Catastro.Update_Value_acceditario(m_Application, "Acceditario")  'registra fecha
                '                cls_Catastro.Quitar_Layer("Acceditario", m_Application)
            ...
            Case "OP_47" 'Area Disponible DM
                ...
                If num_dm_areadisponible = "0" Then
                    ...
                    dm_prioritario = cls_Oracle.FT_INS_DM_PRIORITARIO()
                    ...
                    upd_dm_int = cls_Oracle.FT_UPD_DM_AREADISPONIBLE_INT()

                    upd_dm_lib = cls_Oracle.FT_UPD_DM_AREADISPONIBLE_LIB()
                ...
                'Algo similar para los PRIORITARIOSXDIA
                ...
                If dm_areadisponible = "1" Or dm_prioritario = "1" Then
                    ...
                    'Se asigna STATUS = 3 a los DMs ingresados en las capas C y P --> cambio 14/04/2023

                    Dim upd_areadisponible As String = "0"
                    upd_areadisponible = cls_Oracle.P_UPD_AREADISPONIBLE()
            ...
            Case "OP_24" 'DM Simultaneos
                ...
                'Se agrega fecha de libre denunciabilidad valida
                Dim feclibden As Date = #1/1/2020#
                ...
                fecsimul = Trim(Microsoft.VisualBasic.Left(Format(dtpFecha1.Value), 10))
                ...
                Dim verifica_simu As String = "0"
                verifica_simu = cls_Oracle.FT_VERIFICA_SIMU(fecsimul)

                If verifica_simu = "0" Then
                    Dim p As New Process
                    Dim output As String
                    p.StartInfo.UseShellExecute = False
                    p.StartInfo.RedirectStandardOutput = True
                    p.StartInfo.FileName = _bat_simultaneidad    '"U:\DATOS\SHAPE\process\execute\simultaneidad.bat"
                    'p.StartInfo.Arguments = "03/01/2018"
                    'p.StartInfo.Arguments = fecsimul
                    Dim params As String = String.Format("{0} {1} {2}", fecsimul, gstrUsuarioAcceso, gstrUsuarioClave)
                    ...
                    'MessageBox.Show(json("Z17").ToString())
                    'MessageBox.Show(json("Z17")("G1").ToString())
                    'MessageBox.Show(json("Z17")("G1")("subgrupos").ToString())

                    'Dim json As String = "{'Table1': [{'id': 0,'item': 'item 0'},{'id': 1,'item': 'item 1'}]}"
                    'Dim jsonString As String = "{'Table1':" & output & "}"
                    'Dim dataSet As DataSet = JsonConvert.DeserializeObject(Of DataSet)(jsonString)
                    'Dim dataTable As DataTable = dataSet.Tables("Table1")

                    'Dim dtsimul As New DataTable
                    'Dim jsonString As String = "{'Table1':" & output & "}"
                    'Dim dsetsim As DataSet = JsonConvert.DeserializeObject(Of DataSet)(jsonString)
                    'dtsimul = dsetsim.Tables("Table1")
                    ...
                    'del_tabla = cls_Oracle.P_DEL_TABLA_SIMUL(v_tipo)     'ELIMIMA TODOS LOS REGISTROS DE LA TABLA DONDE SE ALMACENARA  dtsimul

                    'For i As Integer = 0 To dtsimul.Rows.Count - 1
                    '    s_grusim = dtsimul.Rows(i).Item("GRUPO").ToString 'p_ListBox.Items(i).SubItems(0).Text
                    '    s_cuadric = dtsimul.Rows(i).Item("CUADRICULA").ToString 'p_ListBox.Items(i).SubItems(2).Text
                    '    s_grupof = dtsimul.Rows(i).Item("SUBGRUPO_NUM").ToString 'p_ListBox.Items(i).SubItems(2).Text
                    '    s_zona = dtsimul.Rows(i).Item("ZONA").ToString ' p_ListBox.Items(i).SubItems(3).Text
                    '    s_codi = dtsimul.Rows(i).Item("CODIGOU").ToString 'p_ListBox.Items(i).SubItems(0).Text
                    '    s_subgrupo = dtsimul.Rows(i).Item("SUBGRUPO").ToString 'p_ListBox.Items(i).SubItems(0).Text

                    '    'RetornoTabla1 = cls_Oracle.P_INS_SIMULTANEOS(fecsimul, grusim, sgrupo_sim, vnum_dm, num_cuasim)
                    '    RetornoTabla = cls_Oracle.P_INS_SEL_GRUPOSIM_LD(fecsimul, v_tipo, s_grusim, s_cuadric, s_zona, s_codi, s_grupof, s_subgrupo)
                ...
                ''''''   A PARTIR DE ESTA LINEA SE REALIZARAN CAMBIOS - CODIGO DE REMATE -----------------------
                v_petsimul = cls_Oracle.FT_REPO_PETSIM_LD(v_tipo, fecsimul)      'Lo que se muestra en el Datagrid (Grupos y Subgrupos consolidados)  -- (se cambio package)

                v_dmxgrupo = cls_Oracle.FT_DMXGRSIMUL(fecsimul)       'Lista los DMs y sus grupos (DataTable)

                v_concesionxgrupo = cls_Oracle.FT_CONCESIONXGRSIMUL(fecsimul)       'Lista los codigos de los DMs y los grupos y subgrupos correspondientes


                'SE AGREGA PARA ACTUALIZAR CAMPO SI_CODREMATE
                Dim actualiza_simu As String = "0"
                If DateTime.Parse(fecsimul) > feclibden Then

                    Dim fechalib As String = "0" & fecsimul
                    actualiza_simu = cls_Oracle.FT_UPD_DMXGRSIMUL(fechalib)
                End If


                ''''''''''''''''''' falta probar ''''''''''''''''''''
                '' SE AGREGA PARA ACTUALIZAR TABLA   SG_D_DMXHAGRSIMUL
                cls_Oracle.P_INS_DMXHAGRSIMUL_TOT(fecsimul)
                '''''''''''''''''''''''''''''''''''''''''''''''''''''


                fecha_archi = DateTime.Now.Ticks.ToString()
                TableDMSimul = "DMSimul" & fecha_archi
                'cls_Catastro.creandotabla_Rep_DMSimul(TableDMSimul)    
                cls_Catastro.creatabla_dbf(TableDMSimul)                 ' Crea la Tabla y llena los registros con los valores del DataTable (v_concesionxgrupo)
    ...
    Private Sub btnexp_excel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexp_excel.Click
        Select Case Me.cbo_tipo.SelectedValue
            ...
            Case "OP_47" 'Area disponible DM
                ...
                ExportarDatosExcel(dgdResultado, "REPORTE DE PETITORIOS CON SUS ÁREAS DISPONIBLES")
    ...
    Private Sub lblSecPub_Click(sender As Object, e As EventArgs) Handles lblSecPub.Click
    ...
    Private Sub pbox_reporte_dm_libden_int_Click(sender As Object, e As EventArgs) Handles pbox_reporte_dm_libden_int.Click

        Dim frm As New form_ueas

        Dim _parametros_xls As String = "--user {0} --password {1} {2} 2 xls"

        Dim _parametros_html As String = "--user {0} --password {1} {2} 2 html"

        Dim _fn_reporte_libden As String = "generar_reporte"

        Try
            Dim RetVal = Shell(path_loader_proceso_general, 1)

            Dim params = String.Format(_parametros_xls, gstrUsuarioAcceso, gstrUsuarioClave, _fn_reporte_libden)
            Dim json As Linq.JObject = frm.ejecutar_procesos(_bat_libden, params)
            ...
            Dim params_html = String.Format(_parametros_html, gstrUsuarioAcceso, gstrUsuarioClave, _fn_reporte_libden)
            Dim json_html As Linq.JObject = frm.ejecutar_procesos(_bat_libden, params_html)
            Dim estado_html As Integer = json_html.SelectToken("estado")
            If estado_html = 0 Then
                Dim msg_error As String = json_html.SelectToken("msg")
                Throw New System.Exception(msg_error)
            End If
    ...
    Private Sub pbox_reporte_dm_libden_Click(sender As Object, e As EventArgs) Handles pbox_reporte_dm_libden.Click
        Dim frm As New form_ueas

        Dim _parametros_xls As String = "--user {0} --password {1} {2} 1 xls"

        Dim _parametros_html As String = "--user {0} --password {1} {2} 1 html"
    ...
    Private Sub lbl_reporte_libden_Click(sender As Object, e As EventArgs) Handles lbl_reporte_libden.Click

    End Sub

    Private Sub generar_reporte_evaluacion_libre_denu()
        Try
            Kill("C:\BDGEOCATMIN\Temporal\Libredenu\*.xls")       '@jy
        Catch ex As Exception
        End Try
        ...
        Dim result = ExecuteGP(_tool_lib_generarReporte, _params, _toolboxPathLib, True, False)
        Cursor = Cursors.Default
        Dim response = Split(result, ";")
        If response(0) <> 1 Then
            error_scripttool_as_messagebox("Error en la generación de libredenunciabilidad")
        End If
    End Sub

    Private Sub btnRepAvisoRet_Click(sender As Object, e As EventArgs) Handles btnRepAvisoRet.Click
        Dim RetVal = Shell(glo_Path & "\estilos\Barra_Proceso.exe", 1)
        Dim libredenupath As String = "C:\bdgeocatmin\Temporal\Libredenu"
        ''####### Ejecutar generacion de reportes evaluados de libre denunciabilidad ####
        btnRepAvisoRet.Parent.Enabled = False
        generar_reporte_evaluacion_libre_denu()
        btnRepAvisoRet.Parent.Enabled = True
        cls_eval.cierra_ejecutable()
        MessageBox.Show("Se generaron los reportes de aviso de retiro y libre denunciabilidad")
        Process.Start("explorer.exe", libredenupath)
    End Sub
End Class
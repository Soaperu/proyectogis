...
Public Class Frm_Ingreso_AreasRestringidas
    ...
    Private Sub btnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        'TRAIDO DEL 15-06-2017  QIUE ESTABA BIEN EN EL ANTERIOR APLICATIVO  CQ -01-02-18
        '*********************************************************
        ...
        Try
            ...
            For w As Integer = 0 To dgdDetalle.BindingContext(dgdDetalle.DataSource, dgdDetalle.DataMember).Count - 1
                ...
                If dgdDetalle.Item(w, "SELEC") = True Then
                    ...
                    If sele_tipo = "ZU" Or sele_tipo = "U1" Then
                                        ...
                                        If (tipo_catanominero = "AREA RESERVADA") Or (tipo_catanominero = "ZONA URBANA") Then
                                            ...
                                            Do While Not pFeaturepout Is Nothing
                                                If tipo_catanominero = "AREA RESERVADA" Then
                                                    ...
                                                    '    If v_clase_rese = "N" Then
                                                    '        pFeaturepout1.Value(pFeatureCursor.FindFi0eld("FEC_PUB")) = val_fecpub
                                                    '    Else  'Si es Amortiguamiento va fecha de publicación del area amortiguamiento
                                                    '        pFeaturepout1.Value(pFeatureCursor.FindField("FEC_PUB")) = val_fec_pubRESO_norma
                                                    '    End If
            ...
            'REGISTRANO EL ESTADO

            Dim valor_ing As String
            ...
            Dim lostrRetorno2 As String
            lostrRetorno2 = cls_Oracle.FT_ACTUALIZA_REGISTRO_ANM(v_cod_rese, v_archivo, valor_ing)

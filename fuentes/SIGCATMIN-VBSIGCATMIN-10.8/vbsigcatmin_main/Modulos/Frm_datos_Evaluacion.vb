...
Public Class Frm_datos_Evaluacion
    ...
    Private Sub INICIALIZAR_TIPO_INFORME_ANT()
        ...
        Try
            ...
            Dim informeDictByComboBox As New Dictionary(Of String, String)
            informeDictByComboBox.Add("1", "Informe técnico 1")
            informeDictByComboBox.Add("2", "Informe técnico 2")
            informeDictByComboBox.Add("3", "Libre Denunciabilidad")

            cboInforme.DataSource = informeDictByComboBox
            cboInforme.DisplayMember = "Value"
            cboInforme.ValueMember = "Key"
    ...
    Private Sub INICIALIZAR_TIPO_INFORME()
        ...
        Try
            ...
            informeDictByComboBox.Add("1", "Informe técnico 1")
            informeDictByComboBox.Add("2", "Informe técnico 2")
            informeDictByComboBox.Add("LD", "Libre Denunciabilidad")

            cboInforme.DataSource = New BindingSource(informeDictByComboBox, Nothing)
            cboInforme.DisplayMember = "Value"
            cboInforme.ValueMember = "Key"
        Catch ex As Exception
        End Try
            ...
            If chkbox.Checked Then ' AndAlso CType(sender, Windows.Forms.CheckBox).Name <> chkbox.Name Then
                Select Case chkbox.Name
                    ...
                    Case "Check_dato11"
                        ...
                        val_obs_carta = val_obs_carta & conta & " | " & "OB" & " || "
                        'Validad si ingreso Nombre del Río
                        If Txtrio.Text = "" Then
                            MsgBox("Debe Ingresar el Nombre del Río", MsgBoxStyle.Critical, "Observación..")
                            Exit Sub
                    ...
                    Case "Check_dato13"
                        ...
                        If Txtlaguna.Text = "" Then
                            MsgBox("Debe Ingresar el Nombre de la Laguna", MsgBoxStyle.Critical, "Observación..")
                            Exit Sub
                    ...
                    Case "Check_dato20"
                        ...
                        If txt_posible_Au.Text = "" Then
                            MsgBox("Debe Ingresar el Nombre de Posible Area Urbana", MsgBoxStyle.Critical, "Observación..")
                            Exit Sub
        ...
        ElseIf lostrRetorno_cuenta = 1 Then
                ...
                If chkbox.Checked Then ' AndAlso CType(sender, Windows.Forms.CheckBox).Name <> chkbox.Name Then
                    Select Case chkbox.Name
                        ...
                        Case "Check_dato20"
                            ...
                            val_obs_carta = val_obs_carta & conta & " | " & "OB" & " || "
                            If txt_posible_Au.Text = "" Then
                                MsgBox("Debe Ingresar el Nombre de la Posible Área Urbana", MsgBoxStyle.Critical, "Observación..")
                                Exit Sub
            ...
            If lostrRetorno_eli = 1 Then
                ...
                If Val(lostrRetorno_eli) > 0 Then
                    MsgBox("Se ha Actualizado correctamente la Información a la Base de Datos.", vbExclamation, "Evaluación de DM...")
                    glo_Tool_EVA_02 = True
                    var_fa_validaeval = True
                Else
                    MsgBox("No se pudo completar la operación, ya existe el código", vbExclamation, "Evaluación de DM...")
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        ElseIf lostrRetorno = 0 Then
            ...
            If lostrRetorno_eli = 1 Then
                ...
                End If
                If Val(lostrRetorno_eli) > 0 Then
                    MsgBox("Se Actualizó correctamente.", vbExclamation, "Evaluación de DM...")
                    glo_Tool_EVA_02 = True
                    var_fa_validaeval = True
                Else
                    MsgBox("No se pudo completar la operación, ya existe el código", vbExclamation, "Evaluación de DM...")
